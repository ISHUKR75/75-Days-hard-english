...
// Import real questions for Days 31-75 (replaces the fallback generator for those days)
import { EXTENDED_QUESTIONS } from './practiceData-days31-75';

// Import scalable generated content so every day can reach the requested 950+ practice questions
import { ensurePracticeTarget } from './generatedDayContent';

// Real, handcrafted per-day practice-question banks authored in data/challenge/day-XX/practice-questions.json.
// These are higher quality than the generic filler above and are always preferred when present.
// Add more entries here as additional days get a real practice-questions.json authored.
import day01PracticeJson from '../data/challenge/day-01/practice-questions.json';

const REAL_PRACTICE_JSON_BY_DAY = {
  1: day01PracticeJson.questions,
};

function normalizeRealPracticeQuestion(raw, dayNum) {
  return {
    id: `d${String(dayNum).padStart(2, '0')}-real-${raw.id}`,
    hindi: raw.hindi,
    english: raw.english,
    ...
    tags: raw.tags || [],
    grammarRule: raw.grammarRule || '',
    category: raw.category || '',
    type: 'translation',
  };
}

function getRealPracticeQuestions(dayNum) {
  const raw = REAL_PRACTICE_JSON_BY_DAY[dayNum];
  if (!raw) return null;
  return raw.map((q) => normalizeRealPracticeQuestion(q, dayNum));
}
...
const DAY_01 = [
  ...
  { id:'d01-031', hindi:'वह बस पकड़ता है।', english:'He catches the bus.', alternatives:['he takes the bus.'], hint:'He + catches (verb+s)', type:'translation' },
  { id:'d01-032', hindi:'मेरी दादी कहानियाँ सुनाती हैं।', english:'My grandmother tells stories.', alternatives:['my grandma tells stories.'], hint:'Singular + tells (verb+s)', type:'translation' },
  { id:'d01-033', hindi:'वे सब्ज़ियाँ खाते हैं।', english:'They eat vegetables.', alternatives:['they eat veggies.'], hint:'They + base verb', type:'translation' },
  { id:'d01-034', hindi:'मैं संगीत सुनता हूँ।', english:'I listen to music.', alternatives:['i love listening to music.'], hint:'I + listen to', type:'translation' },
  { id:'d01-035', hindi:'वह मुझे रोज़ फ़ोन करता है।', english:'He calls me every day.', alternatives:['he phones me daily.'], hint:'He + calls (verb+s)', type:'translation' },
  { id:'d01-036', hindi:'बिल्ली दूध पीती है।', english:'The cat drinks milk.', alternatives:['cats drink milk.'], hint:'Singular noun + verb+s', type:'translation' },
  { id:'d01-037', hindi:'हम रोज़ अख़बार पढ़ते हैं।', english:'We read the newspaper every day.', alternatives:['we read the paper daily.'], hint:'We + base verb', type:'translation' },
  { id:'d01-038', hindi:'मेरे नाना खेत में काम करते हैं।', english:'My grandfather works in the field.', alternatives:['my grandpa works on the farm.'], hint:'Singular + works (verb+s)', type:'translation' },
  { id:'d01-039', hindi:'वह अपने कमरे को साफ़ रखती है।', english:'She keeps her room clean.', alternatives:['she keeps her room tidy.'], hint:'She + keeps (verb+s)', type:'translation' },
  { id:'d01-040', hindi:'बच्चे स्कूल में पढ़ते हैं।', english:'Children study in school.', alternatives:['kids study at school.'], hint:'Plural + base verb', type:'translation' },
  { id:'d01-041', hindi:'मेरा कुत्ता हड्डी खाता है।', english:'My dog eats bones.', alternatives:['my dog chews bones.'], hint:'My dog + eats (verb+s)', type:'translation' },
  { id:'d01-042', hindi:'मैं हर शाम टहलता हूँ।', english:'I walk every evening.', alternatives:['i go for a walk every evening.'], hint:'I + base verb + time', type:'translation' },
  { id:'d01-043', hindi:'वह बहुत मीठा खाती है।', english:'She eats a lot of sweets.', alternatives:['she loves sweet food.'], hint:'She + eats (verb+s)', type:'translation' },
  { id:'d01-044', hindi:'हमारी टीम जीतती है।', english:'Our team wins.', alternatives:['our team always wins.'], hint:'Our team + wins (verb+s)', type:'translation' },
  { id:'d01-045', hindi:'मछलियाँ पानी में तैरती हैं।', english:'Fish swim in water.', alternatives:['fish live in water.'], hint:'Plural + base verb', type:'translation' },
  { id:'d01-046', hindi:'वह हिंदी और अंग्रेज़ी बोलता है।', english:'He speaks Hindi and English.', alternatives:['he knows hindi and english.'], hint:'He + speaks (verb+s)', type:'translation' },
  { id:'d01-047', hindi:'मेरी माँ सुबह जल्दी उठती हैं।', english:'My mother wakes up early in the morning.', alternatives:['my mom gets up early.'], hint:'Singular + wakes up (verb+s)', type:'translation' },
  { id:'d01-048', hindi:'वे साथ में खाना खाते हैं।', english:'They eat together.', alternatives:['they have meals together.'], hint:'They + base verb', type:'translation' },
  { id:'d01-049', hindi:'चाँद रात में चमकता है।', english:'The moon shines at night.', alternatives:['the moon glows at night.'], hint:'Fact = simple present', type:'translation' },
  { id:'d01-050', hindi:'मैं दूध पीता हूँ।', english:'I drink milk.', alternatives:['i have milk.'], hint:'I + base verb', type:'translation' },
  { id:'d01-051', hindi:'मेरे दोस्त मेरे साथ खेलते हैं।', english:'My friends play with me.', alternatives:['my friends play along with me.'], hint:'Plural + base verb', type:'translation' },
  { id:'d01-052', hindi:'वह हर सुबह योगा करती है।', english:'She does yoga every morning.', alternatives:['she practices yoga every morning.'], hint:'She + does (verb+s)', type:'translation' },
  { id:'d01-053', hindi:'मैं रात में किताब पढ़ता हूँ।', english:'I read a book at night.', alternatives:['i read books at night.'], hint:'I + base verb', type:'translation' },
  { id:'d01-054', hindi:'शेर जंगल में रहते हैं।', english:'Lions live in the forest.', alternatives:['lions stay in the jungle.'], hint:'Plural + base verb', type:'translation' },
  { id:'d01-055', hindi:'मेरे पिता सुबह अख़बार पढ़ते हैं।', english:'My father reads the newspaper in the morning.', alternatives:['my dad reads the paper every morning.'], hint:'Singular + reads (verb+s)', type:'translation' },
  { id:'d01-056', hindi:'वे हर रविवार चर्च जाते हैं।', english:'They go to church every Sunday.', alternatives:['they attend church on sundays.'], hint:'They + base verb', type:'translation' },
  { id:'d01-057', hindi:'मेरा बेटा फुटबॉल खेलता है।', english:'My son plays football.', alternatives:['my son plays soccer.'], hint:'Singular + plays (verb+s)', type:'translation' },
  { id:'d01-058', hindi:'हम सब मिलकर पढ़ते हैं।', english:'We all study together.', alternatives:['we study together as a group.'], hint:'We + base verb', type:'translation' },
  { id:'d01-059', hindi:'वह हर रात 8 बजे सो जाती है।', english:'She sleeps at 8 every night.', alternatives:['she goes to bed at 8 pm every night.'], hint:'She + sleeps (verb+s)', type:'translation' },
  { id:'d01-060', hindi:'पत्ते पेड़ से गिरते हैं।', english:'Leaves fall from trees.', alternatives:['leaves drop from trees.'], hint:'Plural + base verb (natural fact)', type:'translation' },
  { id:'d01-061', hindi:'मैं सब्ज़ी बाज़ार से लाता हूँ।', english:'I buy vegetables from the market.', alternatives:['i get vegetables from the market.'], hint:'I + base verb + from', type:'translation' },
  { id:'d01-062', hindi:'वह दफ़्तर में काम करती है।', english:'She works in the office.', alternatives:['she works at the office.'], hint:'She + works (verb+s)', type:'translation' },
  { id:'d01-063', hindi:'हमारा देश भारत है।', english:'Our country is India.', alternatives:['we live in india.'], hint:'Our country + is', type:'translation' },
  { id:'d01-064', hindi:'मेरी दीदी नर्स है।', english:'My sister is a nurse.', alternatives:['my elder sister is a nurse.'], hint:'Singular + is + profession', type:'translation' },
  { id:'d01-065', hindi:'वे बहुत अच्छा गाना गाते हैं।', english:'They sing very well.', alternatives:['they are great singers.'], hint:'They + base verb + adverb', type:'translation' },
  { id:'d01-066', hindi:'मैं रोज़ सुबह दाँत साफ़ करता हूँ।', english:'I brush my teeth every morning.', alternatives:['i clean my teeth every morning.'], hint:'Daily routine = simple present', type:'translation' },
  { id:'d01-067', hindi:'वह बहुत तेज़ बोलता है।', english:'He speaks very fast.', alternatives:['he talks very fast.'], hint:'He + speaks (verb+s) + adverb', type:'translation' },
  { id:'d01-068', hindi:'मेरी माँ मुझसे बहुत प्यार करती है।', english:'My mother loves me very much.', alternatives:['my mom loves me a lot.'], hint:'Singular + loves (verb+s)', type:'translation' },
  { id:'d01-069', hindi:'हाथी बहुत बड़े होते हैं।', english:'Elephants are very big.', alternatives:['elephants are huge animals.'], hint:'Plural + are + adjective (fact)', type:'translation' },
  { id:'d01-070', hindi:'मैं हर दिन कुछ नया सीखता हूँ।', english:'I learn something new every day.', alternatives:['i try to learn something new daily.'], hint:'I + base verb', type:'translation' },
  { id:'d01-071', hindi:'वह अपने परिवार के साथ रहती है।', english:'She lives with her family.', alternatives:['she stays with her family.'], hint:'She + lives (verb+s)', type:'translation' },
  { id:'d01-072', hindi:'मेरा दोस्त बहुत हँसमुख है।', english:'My friend is very cheerful.', alternatives:['my friend is always happy.'], hint:'Singular + is + adjective', type:'translation' },
  { id:'d01-073', hindi:'वे कभी-कभी सिनेमा जाते हैं।', english:'They sometimes go to the cinema.', alternatives:['they sometimes watch movies.'], hint:'They + base verb + sometimes', type:'translation' },
  { id:'d01-074', hindi:'मैं सुबह चाय पीता हूँ।', english:'I drink tea in the morning.', alternatives:['i have tea every morning.'], hint:'I + base verb', type:'translation' },
  { id:'d01-075', hindi:'वह हर सुबह दौड़ता है।', english:'He runs every morning.', alternatives:['he jogs every morning.'], hint:'He + runs (verb+s)', type:'translation' },
  { id:'d01-076', hindi:'मेरे भाई की नौकरी बैंक में है।', english:'My brother works in a bank.', alternatives:['my brother has a job at a bank.'], hint:'Singular + works (verb+s)', type:'translation' },
  { id:'d01-077', hindi:'बच्चे मिठाई पसंद करते हैं।', english:'Children like sweets.', alternatives:['kids love candy.'], hint:'Plural + base verb', type:'translation' },
  { id:'d01-078', hindi:'वह खूब मेहनत करता है।', english:'He works very hard.', alternatives:['he puts in a lot of effort.'], hint:'He + works (verb+s)', type:'translation' },
  { id:'d01-079', hindi:'हम रोज़ घर की सफ़ाई करते हैं।', english:'We clean the house every day.', alternatives:['we tidy up the house daily.'], hint:'We + base verb', type:'translation' },
  { id:'d01-080', hindi:'गाय घास खाती है।', english:'The cow eats grass.', alternatives:['cows eat grass.'], hint:'Singular + eats (verb+s)', type:'translation' },
  { id:'d01-081', hindi:'मैं अपने दोस्तों के साथ क्रिकेट खेलता हूँ।', english:'I play cricket with my friends.', alternatives:['i play cricket with friends.'], hint:'I + base verb', type:'translation' },
  { id:'d01-082', hindi:'मेरी बहन हर शाम गाती है।', english:'My sister sings every evening.', alternatives:['my sister sings in the evenings.'], hint:'Singular + sings (verb+s)', type:'translation' },
  { id:'d01-083', hindi:'वे हर साल पहाड़ों पर जाते हैं।', english:'They go to the mountains every year.', alternatives:['they visit the mountains annually.'], hint:'They + base verb + time', type:'translation' },
  { id:'d01-084', hindi:'मैं खाने के बाद हाथ धोता हूँ।', english:'I wash my hands after eating.', alternatives:['i clean my hands after meals.'], hint:'Daily habit = simple present', type:'translation' },
  { id:'d01-085', hindi:'नदी समुद्र में मिलती है।', english:'The river meets the sea.', alternatives:['rivers flow into the ocean.'], hint:'Scientific fact = simple present', type:'translation' },
  { id:'d01-086', hindi:'वह अपनी माँ की मदद करती है।', english:'She helps her mother.', alternatives:['she assists her mom.'], hint:'She + helps (verb+s)', type:'translation' },
  { id:'d01-087', hindi:'मेरे चाचा डॉक्टर हैं।', english:'My uncle is a doctor.', alternatives:['my uncle works as a doctor.'], hint:'Singular + is + profession', type:'translation' },
  { id:'d01-088', hindi:'हम सब भारत से प्यार करते हैं।', english:'We all love India.', alternatives:['we all love our country.'], hint:'We + base verb', type:'translation' },
  { id:'d01-089', hindi:'वह हमेशा समय पर आता है।', english:'He always comes on time.', alternatives:['he is always punctual.'], hint:'He + comes (verb+s) + always', type:'translation' },
  { id:'d01-090', hindi:'तोते रंग-बिरंगे होते हैं।', english:'Parrots are colourful.', alternatives:['parrots have colourful feathers.'], hint:'Plural + are + adjective (fact)', type:'translation' },
  { id:'d01-091', hindi:'मैं हर हफ्ते बाज़ार जाता हूँ।', english:'I go to the market every week.', alternatives:['i visit the market weekly.'], hint:'I + base verb', type:'translation' },
  { id:'d01-092', hindi:'वह रोज़ शाम को टहलती है।', english:'She goes for a walk every evening.', alternatives:['she takes a walk in the evenings.'], hint:'She + goes (verb+s)', type:'translation' },
  { id:'d01-093', hindi:'मेरे दोस्त बास्केटबॉल खेलते हैं।', english:'My friends play basketball.', alternatives:['my friends enjoy playing basketball.'], hint:'Plural + base verb', type:'translation' },
  { id:'d01-094', hindi:'कमल पानी में खिलता है।', english:'The lotus blooms in water.', alternatives:['lotuses grow in water.'], hint:'Natural fact = simple present', type:'translation' },
  { id:'d01-095', hindi:'मैं अपना कमरा रोज़ साफ़ करता हूँ।', english:'I clean my room every day.', alternatives:['i tidy my room daily.'], hint:'Daily habit = simple present', type:'translation' },
  { id:'d01-096', hindi:'वह बहुत कम बोलता है।', english:'He speaks very little.', alternatives:['he is a man of few words.'], hint:'He + speaks (verb+s) + adverb', type:'translation' },
  { id:'d01-097', hindi:'मेरी कक्षा में 40 छात्र हैं।', english:'There are 40 students in my class.', alternatives:['my class has 40 students.'], hint:'There are + number + noun', type:'translation' },
  { id:'d01-098', hindi:'हम सब खाना मिलकर खाते हैं।', english:'We all eat together.', alternatives:['we have meals together.'], hint:'We + base verb', type:'translation' },
  { id:'d01-099', hindi:'वह स्कूल में पढ़ाती है।', english:'She teaches in school.', alternatives:['she is a school teacher.'], hint:'She + teaches (verb+s)', type:'translation' },
  { id:'d01-100', hindi:'मैं रोज़ रात 10 बजे सोता हूँ।', english:'I sleep at 10 pm every night.', alternatives:['i go to bed at 10 every night.'], hint:'Daily routine = simple present', type:'translation' },
  { id:'d01-101', hindi:'मेरे पड़ोसी बहुत अच्छे हैं।', english:'My neighbours are very nice.', alternatives:['my neighbors are very good people.'], hint:'Plural + are + adjective', type:'translation' },
  { id:'d01-102', hindi:'वह अपने बच्चों को पढ़ाता है।', english:'He teaches his children.', alternatives:['he educates his kids.'], hint:'He + teaches (verb+s)', type:'translation' },
];
...
const DAY_02 = [
  ...
  { id:'d02-031', hindi:'मेरा नाम अर्जुन कुमार है।', english:'My name is Arjun Kumar.', alternatives:['i am arjun kumar.'], hint:'My name is + full name', type:'translation' },
  { id:'d02-032', hindi:'मैं बेंगलुरु में रहता हूँ।', english:'I live in Bengaluru.', alternatives:['i stay in bangalore.'], hint:'I live in + city', type:'translation' },
  { id:'d02-033', hindi:'मेरी उम्र 28 साल है।', english:'I am 28 years old.', alternatives:['i am 28.','my age is 28.'], hint:'I am + age + years old', type:'translation' },
  { id:'d02-034', hindi:'मैं एक मार्केटिंग मैनेजर हूँ।', english:'I am a marketing manager.', alternatives:['i work as a marketing manager.'], hint:'I am a + job title', type:'translation' },
  { id:'d02-035', hindi:'मेरे परिवार में 5 लोग हैं।', english:'There are 5 people in my family.', alternatives:['my family has 5 members.'], hint:'There are + number + in my family', type:'translation' },
  { id:'d02-036', hindi:'मुझे फ़ोटोग्राफी का शौक है।', english:'I have a passion for photography.', alternatives:['photography is my hobby.'], hint:'I have a passion for + noun', type:'translation' },
  { id:'d02-037', hindi:'मेरी माँ एक टीचर हैं।', english:'My mother is a teacher.', alternatives:['my mom is a teacher.'], hint:'Mother + is a + profession', type:'translation' },
  { id:'d02-038', hindi:'मेरे पिता एक बिज़नेसमैन हैं।', english:'My father is a businessman.', alternatives:['my dad runs a business.'], hint:'Father + is a + profession', type:'translation' },
  { id:'d02-039', hindi:'मैं पिछले 3 साल से इस कंपनी में काम कर रहा हूँ।', english:'I have been working in this company for 3 years.', alternatives:['i have been with this company for three years.'], hint:'I have been working for + time', type:'translation' },
  { id:'d02-040', hindi:'मुझे पढ़ना और लिखना बहुत पसंद है।', english:'I love reading and writing.', alternatives:['i enjoy reading and writing.'], hint:'I love + verb+ing and verb+ing', type:'translation' },
  { id:'d02-041', hindi:'मैंने बीटेक किया है।', english:'I have done B.Tech.', alternatives:['i completed my b.tech.','i have a b.tech degree.'], hint:'I have done + degree', type:'translation' },
  { id:'d02-042', hindi:'मैं चेन्नई से हूँ।', english:'I am from Chennai.', alternatives:['i belong to chennai.'], hint:'I am from + city', type:'translation' },
  { id:'d02-043', hindi:'मेरे तीन भाई हैं।', english:'I have three brothers.', alternatives:['i have 3 brothers.'], hint:'I have + number + noun', type:'translation' },
  { id:'d02-044', hindi:'मुझे खाना बनाने का शौक है।', english:'I have a hobby of cooking.', alternatives:['cooking is my hobby.','i enjoy cooking.'], hint:'I have a hobby of + verb+ing', type:'translation' },
  { id:'d02-045', hindi:'मेरी एक छोटी बहन है।', english:'I have a younger sister.', alternatives:['i have a little sister.'], hint:'I have a + adjective + noun', type:'translation' },
  { id:'d02-046', hindi:'मेरे नाना जी किसान हैं।', english:'My grandfather is a farmer.', alternatives:['my grandpa is a farmer.'], hint:'Grandfather + is a + profession', type:'translation' },
  { id:'d02-047', hindi:'मैं अभी MBA कर रहा हूँ।', english:'I am currently doing MBA.', alternatives:['i am pursuing an mba right now.'], hint:'I am currently + verb+ing', type:'translation' },
  { id:'d02-048', hindi:'मुझे ट्रैकिंग करना बहुत पसंद है।', english:'I love trekking.', alternatives:['i enjoy trekking.','i like hiking.'], hint:'I love + verb+ing', type:'translation' },
  { id:'d02-049', hindi:'मेरा जन्म जयपुर में हुआ था।', english:'I was born in Jaipur.', alternatives:['i was born and raised in jaipur.'], hint:'I was born in + city', type:'translation' },
  { id:'d02-050', hindi:'मेरी पत्नी एक शिक्षिका हैं।', english:'My wife is a teacher.', alternatives:['my wife works as a teacher.'], hint:'My wife + is a + profession', type:'translation' },
  { id:'d02-051', hindi:'मुझे क्रिकेट देखना पसंद है।', english:'I like watching cricket.', alternatives:['i enjoy watching cricket.'], hint:'I like + verb+ing', type:'translation' },
  { id:'d02-052', hindi:'मेरा सपना IAS अधिकारी बनना है।', english:'My dream is to become an IAS officer.', alternatives:['i dream of becoming an ias officer.'], hint:'My dream is to + become + noun', type:'translation' },
  { id:'d02-053', hindi:'मैं अपने माता-पिता के साथ रहता हूँ।', english:'I live with my parents.', alternatives:['i stay with my parents.'], hint:'I live with + noun', type:'translation' },
  { id:'d02-054', hindi:'मेरी कंपनी IT sector में है।', english:'My company is in the IT sector.', alternatives:['i work in the it industry.'], hint:'My company is in + sector', type:'translation' },
  { id:'d02-055', hindi:'मैं हिंदी, अंग्रेज़ी और तमिल बोल सकता हूँ।', english:'I can speak Hindi, English and Tamil.', alternatives:['i know hindi, english and tamil.'], hint:'I can speak + languages', type:'translation' },
  { id:'d02-056', hindi:'मेरी रुचि चित्रकारी में है।', english:'I am interested in painting.', alternatives:['my hobby is painting.'], hint:'I am interested in + noun', type:'translation' },
  { id:'d02-057', hindi:'मेरे दो बच्चे हैं।', english:'I have two children.', alternatives:['i have 2 kids.'], hint:'I have + number + noun', type:'translation' },
  { id:'d02-058', hindi:'मैं कोलकाता में पला-बढ़ा हूँ।', english:'I grew up in Kolkata.', alternatives:['i was raised in kolkata.'], hint:'I grew up in + city', type:'translation' },
  { id:'d02-059', hindi:'मुझे खेलों में बहुत रुचि है।', english:'I am very interested in sports.', alternatives:['i love sports.'], hint:'I am interested in + noun', type:'translation' },
  { id:'d02-060', hindi:'मैंने पिछले साल यह कोर्स पूरा किया।', english:'I completed this course last year.', alternatives:['i finished this course last year.'], hint:'I completed + noun + last year', type:'translation' },
  { id:'d02-061', hindi:'मेरे बॉस मुझ पर भरोसा करते हैं।', english:'My boss trusts me.', alternatives:['my manager trusts me.'], hint:'My boss + trusts (verb+s)', type:'translation' },
  { id:'d02-062', hindi:'मैं हर हफ्ते gym जाता हूँ।', english:'I go to the gym every week.', alternatives:['i visit the gym weekly.'], hint:'I go to + place + time', type:'translation' },
  { id:'d02-063', hindi:'मेरी बड़ी उपलब्धि यह है कि मैंने UPSC पास किया।', english:'My biggest achievement is that I passed UPSC.', alternatives:['my greatest achievement is clearing upsc.'], hint:'My biggest achievement is + clause', type:'translation' },
  { id:'d02-064', hindi:'मैं 5 साल से यहाँ रह रहा हूँ।', english:'I have been living here for 5 years.', alternatives:['i have stayed here for five years.'], hint:'I have been living for + time', type:'translation' },
  { id:'d02-065', hindi:'मेरी माँ बहुत मज़बूत इंसान हैं।', english:'My mother is a very strong person.', alternatives:['my mom is a very strong woman.'], hint:'My mother + is + adjective + noun', type:'translation' },
  { id:'d02-066', hindi:'मुझे नई-नई चीज़ें सीखना अच्छा लगता है।', english:'I enjoy learning new things.', alternatives:['i like learning new things.'], hint:'I enjoy + verb+ing', type:'translation' },
  { id:'d02-067', hindi:'मेरे परिवार में सब बहुत मिलनसार हैं।', english:'Everyone in my family is very friendly.', alternatives:['all members of my family are very friendly.'], hint:'Everyone + is + adjective', type:'translation' },
  { id:'d02-068', hindi:'मेरी कंपनी में 200 से ज़्यादा कर्मचारी हैं।', english:'My company has more than 200 employees.', alternatives:['there are over 200 employees in my company.'], hint:'Company + has + number + noun', type:'translation' },
  { id:'d02-069', hindi:'मैं अपने करियर में आगे बढ़ना चाहता हूँ।', english:'I want to grow in my career.', alternatives:['i want to advance in my career.'], hint:'I want to + grow in + noun', type:'translation' },
  { id:'d02-070', hindi:'मेरा परिवार मुझे हमेशा प्रोत्साहित करता है।', english:'My family always encourages me.', alternatives:['my family always supports me.'], hint:'My family + encourages (verb+s)', type:'translation' },
  { id:'d02-071', hindi:'मैं हैदराबाद में काम करता हूँ।', english:'I work in Hyderabad.', alternatives:['i am based in hyderabad.'], hint:'I work in + city', type:'translation' },
  { id:'d02-072', hindi:'मेरे पास 5 साल का अनुभव है।', english:'I have 5 years of experience.', alternatives:['i have five years of work experience.'], hint:'I have + number + years of experience', type:'translation' },
  { id:'d02-073', hindi:'मुझे लोगों से मिलना अच्छा लगता है।', english:'I enjoy meeting people.', alternatives:['i like socializing.'], hint:'I enjoy + verb+ing', type:'translation' },
  { id:'d02-074', hindi:'मेरा भाई विदेश में पढ़ रहा है।', english:'My brother is studying abroad.', alternatives:['my brother is studying overseas.'], hint:'My brother + is + verb+ing', type:'translation' },
  { id:'d02-075', hindi:'मेरे पिता रिटायर हो चुके हैं।', english:'My father has retired.', alternatives:['my dad is retired.'], hint:'Father + has retired (present perfect)', type:'translation' },
  { id:'d02-076', hindi:'मैं एक सकारात्मक सोच रखता हूँ।', english:'I have a positive attitude.', alternatives:['i am a positive thinker.'], hint:'I have a + adjective + noun', type:'translation' },
  { id:'d02-077', hindi:'मेरी कंपनी बहुत तेज़ी से बढ़ रही है।', english:'My company is growing very fast.', alternatives:['my company is expanding rapidly.'], hint:'Company + is growing + adverb', type:'translation' },
  { id:'d02-078', hindi:'मैं टीम वर्क में विश्वास रखता हूँ।', english:'I believe in teamwork.', alternatives:['i value teamwork.'], hint:'I believe in + noun', type:'translation' },
  { id:'d02-079', hindi:'मुझे नई भाषाएँ सीखना पसंद है।', english:'I like learning new languages.', alternatives:['i enjoy picking up new languages.'], hint:'I like + verb+ing', type:'translation' },
  { id:'d02-080', hindi:'मेरे दोस्त कहते हैं कि मैं मज़ेदार हूँ।', english:'My friends say that I am funny.', alternatives:['according to my friends, i am funny.'], hint:'Friends say + that + clause', type:'translation' },
  { id:'d02-081', hindi:'मेरे घर के पास एक पार्क है।', english:'There is a park near my house.', alternatives:['a park is located near my home.'], hint:'There is + article + noun + near', type:'translation' },
  { id:'d02-082', hindi:'मैं हमेशा अपने लक्ष्य पर ध्यान केंद्रित रहता हूँ।', english:'I always stay focused on my goals.', alternatives:['i always focus on my goals.'], hint:'I always stay + adjective + on', type:'translation' },
  { id:'d02-083', hindi:'मेरे घर में खाना हमेशा बनता है।', english:'Food is always cooked at my home.', alternatives:['my mother always cooks at home.'], hint:'Passive or general present', type:'translation' },
  { id:'d02-084', hindi:'मैं जल्द ही विदेश जाना चाहता हूँ।', english:'I want to go abroad soon.', alternatives:['i plan to travel abroad soon.'], hint:'I want to + verb + soon', type:'translation' },
  { id:'d02-085', hindi:'मुझे बागवानी का शौक है।', english:'I have a hobby of gardening.', alternatives:['gardening is my hobby.'], hint:'My hobby is + noun', type:'translation' },
  { id:'d02-086', hindi:'मेरी दादी मुझसे बहुत प्यार करती हैं।', english:'My grandmother loves me very much.', alternatives:['my granny loves me a lot.'], hint:'Singular + loves (verb+s)', type:'translation' },
  { id:'d02-087', hindi:'मेरे पास एक कुत्ता है।', english:'I have a dog.', alternatives:['i own a dog.'], hint:'I have + article + noun', type:'translation' },
  { id:'d02-088', hindi:'मुझे स्वीमिंग बहुत पसंद है।', english:'I love swimming.', alternatives:['i enjoy swimming.'], hint:'I love + verb+ing', type:'translation' },
  { id:'d02-089', hindi:'मेरा लक्ष्य एक सफल उद्यमी बनना है।', english:'My goal is to become a successful entrepreneur.', alternatives:['i aim to be a successful entrepreneur.'], hint:'My goal is to become + noun', type:'translation' },
  { id:'d02-090', hindi:'मैं सोशल मीडिया पर ज़्यादा समय नहीं बिताता।', english:'I do not spend much time on social media.', alternatives:["i don't spend too much time on social media."], hint:"I don't spend + time + on", type:'translation' },
  { id:'d02-091', hindi:'मेरे परिवार में हर कोई मेहनती है।', english:'Everyone in my family is hardworking.', alternatives:['all my family members are hardworking.'], hint:'Everyone + is + adjective', type:'translation' },
  { id:'d02-092', hindi:'मैं एक छोटे से शहर में पला-बढ़ा हूँ।', english:'I grew up in a small town.', alternatives:['i was raised in a small town.'], hint:'I grew up in a + adjective + noun', type:'translation' },
  { id:'d02-093', hindi:'मेरे काम में मुझे बहुत संतुष्टि मिलती है।', english:'I find great satisfaction in my work.', alternatives:['my work gives me a lot of satisfaction.'], hint:'I find + noun + in + noun', type:'translation' },
  { id:'d02-094', hindi:'मैं जल्दी नई चीज़ें सीख लेता हूँ।', english:'I learn new things quickly.', alternatives:['i pick up new skills fast.'], hint:'I learn + adverb', type:'translation' },
  { id:'d02-095', hindi:'मेरे पास एक अच्छा जीवन है।', english:'I have a good life.', alternatives:['i live a good life.'], hint:'I have a + adjective + noun', type:'translation' },
  { id:'d02-096', hindi:'मुझे गणित बहुत पसंद है।', english:'I love mathematics.', alternatives:['i enjoy maths.'], hint:'I love + subject', type:'translation' },
  { id:'d02-097', hindi:'मेरे पिता मुझे हमेशा प्रेरित करते हैं।', english:'My father always motivates me.', alternatives:['my dad always inspires me.'], hint:'Father + motivates (verb+s)', type:'translation' },
  { id:'d02-098', hindi:'मुझे चुनौतियाँ पसंद हैं।', english:'I like challenges.', alternatives:['i enjoy challenges.'], hint:'I like + plural noun', type:'translation' },
  { id:'d02-099', hindi:'मैं अपने भाई का बहुत ध्यान रखता हूँ।', english:'I take great care of my brother.', alternatives:['i look after my brother.'], hint:'I take care of + possessive + noun', type:'translation' },
  { id:'d02-100', hindi:'मेरे सपने बड़े हैं।', english:'My dreams are big.', alternatives:['i have big dreams.'], hint:'My dreams + are + adjective', type:'translation' },
  { id:'d02-101', hindi:'मैंने हमेशा कड़ी मेहनत की है।', english:'I have always worked hard.', alternatives:['i have always been hardworking.'], hint:'I have always + verb3', type:'translation' },
  { id:'d02-102', hindi:'मेरे रिश्तेदार विभिन्न शहरों में रहते हैं।', english:'My relatives live in different cities.', alternatives:['my relatives are spread across different cities.'], hint:'My relatives + live (base verb plural)', type:'translation' },
];
...
const DAY_03 = [
  ...
  { id:'d03-031', hindi:'कृपया अपनी सीट पर बैठें।', english:'Please take your seat.', alternatives:['please sit in your seat.'], hint:'Please + take + your + noun', type:'translation' },
  { id:'d03-032', hindi:'लाइट बंद कर दो।', english:'Turn off the light.', alternatives:['switch off the light.'], hint:'Turn/Switch off + object', type:'translation' },
  { id:'d03-033', hindi:'पंखा चालू कर दो।', english:'Turn on the fan.', alternatives:['switch on the fan.'], hint:'Turn/Switch on + object', type:'translation' },
  { id:'d03-034', hindi:'कृपया इसे दोबारा समझाओ।', english:'Please explain this again.', alternatives:['please explain it again.'], hint:'Please + verb + again', type:'translation' },
  { id:'d03-035', hindi:'अपने हाथ धो लो।', english:'Wash your hands.', alternatives:['wash your hands please.'], hint:'Wash + your + noun', type:'translation' },
  { id:'d03-036', hindi:'ज़ोर से मत हँसो।', english:'Do not laugh loudly.', alternatives:["don't laugh loudly."], hint:"Don't + verb + adverb", type:'translation' },
  { id:'d03-037', hindi:'सड़क पार करते समय ध्यान रखो।', english:'Be careful while crossing the road.', alternatives:['be careful when crossing the road.'], hint:'Be careful while + verb+ing', type:'translation' },
  { id:'d03-038', hindi:'कृपया अपना मोबाइल साइलेंट कर दो।', english:'Please put your mobile on silent.', alternatives:['please silence your phone.'], hint:'Please + verb + object', type:'translation' },
  { id:'d03-039', hindi:'मुझे सच बताओ।', english:'Tell me the truth.', alternatives:['tell me truth.'], hint:'Tell + me + the truth', type:'translation' },
  { id:'d03-040', hindi:'कमरा साफ़ रखो।', english:'Keep the room clean.', alternatives:['keep your room clean.'], hint:'Keep + object + adjective', type:'translation' },
  { id:'d03-041', hindi:'कृपया कतार में खड़े रहो।', english:'Please stand in the queue.', alternatives:['please stand in line.'], hint:'Stand in + the queue/line', type:'translation' },
  { id:'d03-042', hindi:'किसी अजनबी पर भरोसा मत करो।', english:'Do not trust a stranger.', alternatives:["don't trust strangers."], hint:"Don't + trust + noun", type:'translation' },
  { id:'d03-043', hindi:'अपना होमवर्क समय पर पूरा करो।', english:'Complete your homework on time.', alternatives:['finish your homework on time.'], hint:'Complete/Finish + your + noun + on time', type:'translation' },
  { id:'d03-044', hindi:'कृपया एक मिनट रुको।', english:'Please wait a minute.', alternatives:['please wait for a minute.'], hint:'Please + wait + a minute', type:'translation' },
  { id:'d03-045', hindi:'गाड़ी धीरे चलाओ।', english:'Drive the car slowly.', alternatives:['drive slowly.'], hint:'Drive + adverb', type:'translation' },
  { id:'d03-046', hindi:'खिड़की से बाहर मत देखो।', english:'Do not look outside the window.', alternatives:["don't look out of the window."], hint:"Don't + look + preposition", type:'translation' },
  { id:'d03-047', hindi:'सबका सम्मान करो।', english:'Respect everyone.', alternatives:['respect everybody.'], hint:'Respect + everyone', type:'translation' },
  { id:'d03-048', hindi:'कृपया लाइन में लगें।', english:'Please get in line.', alternatives:['please line up.'], hint:'Get in line / Line up', type:'translation' },
  { id:'d03-049', hindi:'फ़ालतू बातें मत करो।', english:'Do not talk unnecessarily.', alternatives:["don't talk nonsense.",'stop talking unnecessarily.'], hint:"Don't + talk + adverb", type:'translation' },
  { id:'d03-050', hindi:'हमेशा मुस्कुराते रहो।', english:'Always keep smiling.', alternatives:['always smile.'], hint:'Always + keep + verb+ing', type:'translation' },
];
...
const DAY_04 = [
  ...
  { id:'d04-031', hindi:'यह मेरा घर है।', english:'This is my house.', alternatives:['this is my home.'], hint:'This is + possessive + noun', type:'translation' },
  { id:'d04-032', hindi:'हम कल व्यस्त थे।', english:'We were busy yesterday.', alternatives:['we were occupied yesterday.'], hint:'Were = past of are', type:'translation' },
  { id:'d04-033', hindi:'क्या वे तैयार हैं?', english:'Are they ready?', alternatives:['are they prepared?'], hint:'Are + they + adjective?', type:'translation' },
  { id:'d04-034', hindi:'यह समस्या गंभीर है।', english:'This problem is serious.', alternatives:['this issue is serious.'], hint:'This + noun + is + adjective', type:'translation' },
  { id:'d04-035', hindi:'हम अभी ऑफिस में हैं।', english:'We are in the office right now.', alternatives:['we are at the office now.'], hint:'We are + preposition + place', type:'translation' },
  { id:'d04-036', hindi:'वह पिछले साल छात्र था।', english:'He was a student last year.', alternatives:['he was a student the previous year.'], hint:'Was a + noun (past)', type:'translation' },
  { id:'d04-037', hindi:'क्या आप निश्चिंत हैं?', english:'Are you sure?', alternatives:['are you certain?'], hint:'Are you + adjective?', type:'translation' },
  { id:'d04-038', hindi:'यह जगह खूबसूरत है।', english:'This place is beautiful.', alternatives:['this place is gorgeous.'], hint:'This + noun + is + adjective', type:'translation' },
  { id:'d04-039', hindi:'हम अतीत में गरीब थे।', english:'We were poor in the past.', alternatives:['we used to be poor.'], hint:'Were + adjective (past)', type:'translation' },
  { id:'d04-040', hindi:'क्या यह सही समय है?', english:'Is this the right time?', alternatives:['is this a good time?'], hint:'Is this + the + adjective + noun?', type:'translation' },
  { id:'d04-041', hindi:'वे लोग बहुत ईमानदार हैं।', english:'Those people are very honest.', alternatives:['they are very honest people.'], hint:'Those/They + are + adjective', type:'translation' },
  { id:'d04-042', hindi:'मैं कल रात सो नहीं पाया था।', english:'I was not able to sleep last night.', alternatives:["i couldn't sleep last night."], hint:'Was not able to + verb', type:'translation' },
  { id:'d04-043', hindi:'यह किताब मेरी है।', english:'This book is mine.', alternatives:['this is my book.'], hint:'This + noun + is + possessive pronoun', type:'translation' },
  { id:'d04-044', hindi:'सभी छात्र मौजूद हैं।', english:'All the students are present.', alternatives:['all students are present.'], hint:'All + noun + are + adjective', type:'translation' },
  { id:'d04-045', hindi:'क्या तुम अकेले थे?', english:'Were you alone?', alternatives:['were you by yourself?'], hint:'Were you + adjective?', type:'translation' },
  { id:'d04-046', hindi:'यह निर्णय गलत था।', english:'This decision was wrong.', alternatives:['this decision was incorrect.'], hint:'This + noun + was + adjective', type:'translation' },
  { id:'d04-047', hindi:'हम सब एक टीम हैं।', english:'We are all one team.', alternatives:['we are a team.'], hint:'We are + noun', type:'translation' },
  { id:'d04-048', hindi:'वह कल थोड़ा परेशान था।', english:'He was a little upset yesterday.', alternatives:['he was slightly upset yesterday.'], hint:'Was a little + adjective', type:'translation' },
  { id:'d04-049', hindi:'क्या यह पानी साफ़ है?', english:'Is this water clean?', alternatives:['is this water pure?'], hint:'Is this + noun + adjective?', type:'translation' },
  { id:'d04-050', hindi:'वे हमेशा सतर्क रहते हैं।', english:'They are always alert.', alternatives:['they always stay alert.'], hint:'They are always + adjective', type:'translation' },
];
...
const DAY_05 = [
  ...
  { id:'d05-031', hindi:'यह मेरा पसंदीदा गाना है।', english:'This is my favourite song.', alternatives:['this is my favorite song.'], hint:'This is my favourite + noun', type:'translation' },
  { id:'d05-032', hindi:'वे कपड़े बहुत महँगे हैं।', english:'Those clothes are very expensive.', alternatives:['those clothes cost a lot.'], hint:'Those + noun + are + adjective', type:'translation' },
  { id:'d05-033', hindi:'क्या ये तुम्हारे बच्चे हैं?', english:'Are these your children?', alternatives:['are these your kids?'], hint:'Are these your + noun?', type:'translation' },
  { id:'d05-034', hindi:'वह इमारत बहुत पुरानी है।', english:'That building is very old.', alternatives:['that building is quite old.'], hint:'That + noun + is + adjective', type:'translation' },
  { id:'d05-035', hindi:'यह मेरा आखिरी मौका है।', english:'This is my last chance.', alternatives:['this is my final chance.'], hint:'This is my + adjective + noun', type:'translation' },
  { id:'d05-036', hindi:'ये आदतें बदलनी होंगी।', english:'These habits need to change.', alternatives:['these habits must be changed.'], hint:'These + noun + need to + verb', type:'translation' },
  { id:'d05-037', hindi:'वह खबर सच नहीं है।', english:'That news is not true.', alternatives:["that news isn't true."], hint:'That + noun + is not + adjective', type:'translation' },
  { id:'d05-038', hindi:'ये जूते बहुत आरामदायक हैं।', english:'These shoes are very comfortable.', alternatives:['these shoes feel very comfortable.'], hint:'These + noun + are + adjective', type:'translation' },
  { id:'d05-039', hindi:'क्या वह तुम्हारी कलम है?', english:'Is that your pen?', alternatives:['is that pen yours?'], hint:'Is that + possessive + noun?', type:'translation' },
  { id:'d05-040', hindi:'यह हमारी आखिरी उम्मीद है।', english:'This is our last hope.', alternatives:['this is our only hope.'], hint:'This is our + adjective + noun', type:'translation' },
];
...
const DAY_06 = [
  ...
  { id:'d06-031', hindi:'मेरे पास एक अच्छा मौका है।', english:'I have a good opportunity.', alternatives:['i have a great opportunity.'], hint:'I have a + adjective + noun', type:'translation' },
  { id:'d06-032', hindi:'क्या तुम्हारे पास इंटरनेट है?', english:'Do you have internet?', alternatives:['have you got internet access?'], hint:'Do you have + noun?', type:'translation' },
  { id:'d06-033', hindi:'उसके पास एक शानदार टीम है।', english:'He has an excellent team.', alternatives:['he has a great team.'], hint:'He has an + adjective + noun', type:'translation' },
  { id:'d06-034', hindi:'हमारे पास पर्याप्त संसाधन हैं।', english:'We have enough resources.', alternatives:['we have sufficient resources.'], hint:'We have enough + noun', type:'translation' },
  { id:'d06-035', hindi:'मेरे पास दो विकल्प हैं।', english:'I have two options.', alternatives:['i have 2 choices.'], hint:'I have + number + noun', type:'translation' },
  { id:'d06-036', hindi:'क्या उनके पास लाइसेंस है?', english:'Do they have a license?', alternatives:['have they got a license?'], hint:'Do they have + article + noun?', type:'translation' },
  { id:'d06-037', hindi:'इस गाड़ी में अच्छा माइलेज है।', english:'This car has good mileage.', alternatives:['this car gives good mileage.'], hint:'Noun + has + adjective + noun', type:'translation' },
  { id:'d06-038', hindi:'मेरे पास पर्याप्त सबूत हैं।', english:'I have enough evidence.', alternatives:['i have sufficient proof.'], hint:'I have enough + noun', type:'translation' },
  { id:'d06-039', hindi:'उसके पास एक अनोखा हुनर है।', english:'She has a unique skill.', alternatives:['she has a rare talent.'], hint:'She has a + adjective + noun', type:'translation' },
  { id:'d06-040', hindi:'हमारे पास बहुत बड़ा नेटवर्क है।', english:'We have a very large network.', alternatives:['we have a huge network.'], hint:'We have a + adjective + noun', type:'translation' },
];
...
const DAY_07 = [
  ...
  { id:'d07-031', hindi:'उसके पास हमेशा एक योजना होती थी।', english:'He always had a plan.', alternatives:['he always used to have a plan.'], hint:'Always had + article + noun', type:'translation' },
  { id:'d07-032', hindi:'क्या तुम्हारे पास इसका जवाब था?', english:'Did you have the answer to this?', alternatives:['did you have an answer for this?'], hint:'Did you have + the + noun?', type:'translation' },
  { id:'d07-033', hindi:'उस टीम के पास बेहतरीन खिलाड़ी थे।', english:'That team had excellent players.', alternatives:['that team had great players.'], hint:'Team + had + adjective + plural noun', type:'translation' },
  { id:'d07-034', hindi:'मेरे पास तब कोई अनुभव नहीं था।', english:'I had no experience back then.', alternatives:["i didn't have any experience then."], hint:'Had no + noun + back then', type:'translation' },
  { id:'d07-035', hindi:'उसके पास एक सुंदर बगीचा था।', english:'She had a beautiful garden.', alternatives:['she had a lovely garden.'], hint:'She had a + adjective + noun', type:'translation' },
  { id:'d07-036', hindi:'हमारे पास पहले कोई कार नहीं थी।', english:'We did not have a car before.', alternatives:["we didn't have a car earlier."], hint:'Did not have + article + noun', type:'translation' },
  { id:'d07-037', hindi:'क्या उसके पास कोई विकल्प था?', english:'Did he have any choice?', alternatives:['did he have any option?'], hint:'Did he have any + noun?', type:'translation' },
  { id:'d07-038', hindi:'उन दिनों हमारे पास बहुत खाली समय था।', english:'We had a lot of free time in those days.', alternatives:['back then, we had plenty of free time.'], hint:'Had a lot of + noun + in those days', type:'translation' },
  { id:'d07-039', hindi:'उसके पास कहने के लिए बहुत कुछ था।', english:'He had a lot to say.', alternatives:['he had much to say.'], hint:'Had a lot to + verb', type:'translation' },
  { id:'d07-040', hindi:'मेरे पास इस काम के लिए काफी समय था।', english:'I had enough time for this work.', alternatives:['i had sufficient time for this task.'], hint:'Had enough + noun + for + noun', type:'translation' },
];
...
const DAY_08 = [
  ...
  { id:'d08-031', hindi:'अगले हफ्ते तक मैं यह किताब खत्म कर चुका होऊँगा।', english:'By next week, I will have finished this book.', alternatives:['i will have completed this book by next week.'], hint:'By + time + will have + finished + noun', type:'translation' },
  { id:'d08-032', hindi:'क्या तब तक तुमने खाना बना लिया होगा?', english:'Will you have cooked the food by then?', alternatives:['will you have prepared the meal by then?'], hint:'Will + subject + have + cooked?', type:'translation' },
  { id:'d08-033', hindi:'शाम तक बारिश रुक चुकी होगी।', english:'The rain will have stopped by evening.', alternatives:['it will have stopped raining by evening.'], hint:'Will have + stopped + by + time', type:'translation' },
  { id:'d08-034', hindi:'अगले सत्र तक वह परीक्षा पास कर चुका होगा।', english:'He will have passed the exam by next session.', alternatives:['he will have cleared the exam by the next session.'], hint:'Will have + passed/cleared + noun', type:'translation' },
  { id:'d08-035', hindi:'2027 तक यह कंपनी बहुत बड़ी हो चुकी होगी।', english:'By 2027, this company will have grown a lot.', alternatives:['this company will have expanded a lot by 2027.'], hint:'By + year + will have + grown', type:'translation' },
  { id:'d08-036', hindi:'क्या हम तब तक घर पहुँच चुके होंगे?', english:'Will we have reached home by then?', alternatives:['will we have arrived home by then?'], hint:'Will + subject + have + reached?', type:'translation' },
  { id:'d08-037', hindi:'अगले महीने तक वेतन बढ़ चुका होगा।', english:'By next month, the salary will have increased.', alternatives:['the salary will have gone up by next month.'], hint:'Will have + increased + by + time', type:'translation' },
  { id:'d08-038', hindi:'इस सप्ताह के अंत तक हम फैसला ले चुके होंगे।', english:'By the end of this week, we will have made a decision.', alternatives:['we will have decided by the end of this week.'], hint:'By the end of + time + will have + made + decision', type:'translation' },
  { id:'d08-039', hindi:'क्या तुमने अगली सुबह तक जवाब दे दिया होगा?', english:'Will you have replied by next morning?', alternatives:['will you have responded by tomorrow morning?'], hint:'Will + subject + have + replied?', type:'translation' },
  { id:'d08-040', hindi:'साल के अंत तक हम अपना लक्ष्य पूरा कर चुके होंगे।', english:'By the end of the year, we will have achieved our goal.', alternatives:['we will have reached our goal by year end.'], hint:'By the end of + time + will have + achieved + noun', type:'translation' },
];
...
const DAY_09 = [
  ...
  { id:'d09-031', hindi:'इस मुहल्ले में एक भी दुकान नहीं है।', english:'There is not a single shop in this locality.', alternatives:['there are no shops in this neighbourhood.'], hint:'There is not a single + noun + place', type:'translation' },
  { id:'d09-032', hindi:'क्या रसोई में चीनी है?', english:'Is there sugar in the kitchen?', alternatives:['is there any sugar in the kitchen?'], hint:'Is there + noun + place?', type:'translation' },
  { id:'d09-033', hindi:'इस किताब में बहुत सारी गलतियाँ हैं।', english:'There are many mistakes in this book.', alternatives:['this book has many errors.'], hint:'There are many + noun + place', type:'translation' },
  { id:'d09-034', hindi:'बाहर बहुत ठंड है।', english:'There is a lot of cold outside.', alternatives:['it is very cold outside.'], hint:'There is + a lot of + noun', type:'translation' },
  { id:'d09-035', hindi:'क्या कल कोई छुट्टी है?', english:'Is there a holiday tomorrow?', alternatives:['is tomorrow a holiday?'], hint:'Is there + article + noun + time?', type:'translation' },
  { id:'d09-036', hindi:'इस देश में बहुत गरीबी है।', english:'There is a lot of poverty in this country.', alternatives:['there is much poverty in this country.'], hint:'There is a lot of + noun + place', type:'translation' },
  { id:'d09-037', hindi:'मंच पर कोई माइक नहीं था।', english:'There was no mic on the stage.', alternatives:['there was no microphone on the stage.'], hint:'There was no + noun + place', type:'translation' },
  { id:'d09-038', hindi:'क्या पार्टी में कोई खास बात थी?', english:'Was there anything special at the party?', alternatives:['was there something special at the party?'], hint:'Was there + anything + place?', type:'translation' },
  { id:'d09-039', hindi:'भविष्य में और भी नई तकनीकें होंगी।', english:'There will be more new technologies in the future.', alternatives:['there will be more new technology in the future.'], hint:'There will be + more + noun', type:'translation' },
  { id:'d09-040', hindi:'क्या अगले हफ्ते कोई कार्यक्रम होगा?', english:'Will there be any event next week?', alternatives:['is there going to be an event next week?'], hint:'Will there be + any + noun + time?', type:'translation' },
];
...
// Retrieve questions for a day:
// — Days 1-30: from ALL_QUESTIONS (static, handcrafted)
// — Days 31-75: from EXTENDED_QUESTIONS (real questions from practiceData-days31-75.js)
// — Fallback: the dynamic generator (safety net only)
export function getQuestionsForDay(dayNum) {
  const realQuestions = getRealPracticeQuestions(dayNum);
  const existingQuestions = realQuestions || ALL_QUESTIONS[dayNum] || EXTENDED_QUESTIONS[dayNum] || [];
  const topic = DAYS_75_TOPICS.find(t => t.day === dayNum);
  const title = topic ? topic.title : `Day ${dayNum} Topic`;
  const fallbackQuestions = existingQuestions.length > 0 ? existingQuestions : generateQuestionsForDay(dayNum, title);
  return ensurePracticeTarget(dayNum, fallbackQuestions, 950); // Guarantee 950+ rich practice questions for every day (real content is never truncated)
}
...
export const TOTAL_QUESTIONS = 75 * 950;
