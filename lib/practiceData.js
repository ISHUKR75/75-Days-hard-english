...
export function getQuestionsForDay(dayNum) {
  const existingQuestions = ALL_QUESTIONS[dayNum] || EXTENDED_QUESTIONS[dayNum] || [];
  const topic = DAYS_75_TOPICS.find(t => t.day === dayNum);
  ...
  return ensurePracticeTarget(dayNum, fallbackQuestions, 950); // Guarantee 950 rich practice questions for every day
}
