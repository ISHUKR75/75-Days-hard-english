...
/* ═══════════════════════════════════════════════
   10. MEMORY TRICKS  (60 tricks)
═══════════════════════════════════════════════ */
const memoryTricks = {
  day: 2, topic: "Self Introduction – Memory Tricks",
  description: "60 clever memory aids for vocabulary, grammar rules, and phrases used in self-introduction.",
  totalTricks: 60,
  tricks: [
    { id:1, category:"grammar", title:"SINCE vs FOR", trick:"SINCE = a Point in time (like a finger pointing to a calendar date). FOR = a Period of time (like spreading your arms wide). 'I've lived here since 2020' vs 'I've lived here for 4 years'.", visual:"📅 SINCE → Point. ↔️ FOR → Duration.", example:"Since 2019 | For 5 years" },
    { id:2, category:"vocabulary", title:"STATIVE VERBS — no -ing!", trick:"BATH — Believe, Appear, Think, Have. Stative verbs describing states of mind or being NEVER use -ing. 'I believe' ✅ not 'I am believing' ❌", visual:"🛁 BATH = Believe, Appear (seem), Think (opinion), Have (possession)", example:"I have | I believe | I think | I appear" },
    { id:3, category:"grammar", title:"INTERESTED IN vs INTERESTED TO", trick:"Think of 'in' as a container — you are INSIDE the topic, absorbed by it. 'Interested IN doing yoga.' INTERESTED TO sounds like you're moving toward it, which changes the meaning.", visual:"📦 Interested [IN] = you're inside the topic", example:"I am interested in learning. ✅ | I am interested in meeting you." },
    { id:4, category:"vocabulary", title:"EXPERTISE IN (not 'at' or 'on')", trick:"'IN' = inside a field. Think of expertise as living INSIDE a subject, like a fish in water. 'My expertise is IN the water (field).'", visual:"🐟 Expertise → [IN the field]", example:"Expertise in data science | Proficiency in Python" },
    { id:5, category:"grammar", title:"LOOK FORWARD TO + -ing", trick:"'TO' here is a PREPOSITION, not an infinitive marker. Test: can you say 'I look forward to the meeting'? Yes! So 'to' + noun. That means 'to + verb-ING', not 'to + verb'.", visual:"'I look forward to + [NOUN]' → '[VERB] becomes a noun with -ING'", example:"Look forward to meeting | Look forward to the event" },
    { id:6, category:"vocabulary", title:"BORN — always passive!", trick:"Nobody does the act of being born themselves. So it's ALWAYS passive: 'I WAS BORN'. Nobody says 'I born'. Think: 'born' = b-o-r-n = By Others, Received Naturally.", visual:"B-O-R-N = Born = Others did it to you", example:"I was born in Delhi | She was born in 1990" },
    { id:7, category:"grammar", title:"'MYSELF PRIYA' is wrong — Why?", trick:"'Myself' is a MIRROR word — it reflects the subject back. 'I saw myself.' You can't be the mirror AND the subject at the same time. 'Myself Priya' has no subject to reflect.", visual:"🪞 Myself = mirror reflecting 'I' back to itself", example:"I hurt myself. ✅ | Myself Priya. ❌" },
    { id:8, category:"vocabulary", title:"WORK AT vs WORK IN vs WORK AS", trick:"AT = address (specific place). IN = inside a field/industry. AS = role costume (what role you wear). 'I work AT Google, IN tech, AS an engineer.'", visual:"🏢 AT = building. 🌐 IN = field. 👔 AS = costume/role.", example:"Work at Infosys | Work in finance | Work as a developer" },
    { id:9, category:"grammar", title:"GRADUATED FROM (not 'passed out from')", trick:"'Graduated' sounds like GREAT — great completion. 'Passed out' means FAINTED in English! Remember: you didn't faint from college, you GREATUATED (graduated) from it.", visual:"🎓 GRADUATED = Great Exit. 😵 Passed out = Fainted!", example:"I graduated from IIT. ✅ | I passed out from IIT. ❌ (means fainted)" },
    { id:10, category:"pronunciation", title:"'W' vs 'V' Sound", trick:"W = Whisper with a WIDE mouth. V = Vibrate your lower lip against upper teeth. Practice: 'Vine' (V) vs 'Wine' (W). 'Vince drinks wine, Wayne drinks vinegar.'", visual:"W = 🌊 water wave shape. V = ✌️ two fingers pointing.", example:"Work (W) | Very (V) | Wonderful (W) | Vivid (V)" },
    { id:11, category:"vocabulary", title:"PASSIONATE ABOUT (not 'towards')", trick:"'About' circles the topic. 'Towards' moves away. You want your passion to CIRCLE your topic, not run away from it!", visual:"⭕ About = circles topic. → Towards = runs away from it.", example:"Passionate about music. ✅ | Passionate towards music. ❌" },
    { id:12, category:"grammar", title:"Simple Present for Permanent Facts", trick:"'Facts are FLAT' — they don't move or change, so use flat (simple) present. 'I am from Mumbai.' Permanent = flat = simple present. Temporary = use continuous.", visual:"🗿 Permanent = flat, doesn't move = Simple Present", example:"I come from Delhi. ✅ | I live in a hostel (temporary). | I work at TCS." },
    { id:13, category:"grammar", title:"Present Perfect for Recent/Relevant Past", trick:"Think of present perfect as a BRIDGE 🌉 — it connects your past experience to RIGHT NOW. 'I have studied three languages' — study happened before, but result is relevant today.", visual:"🌉 Present Perfect bridges past to now.", example:"I have worked in banking for 5 years. | I have visited 14 states." },
    { id:14, category:"vocabulary", title:"EXPERTISE vs EXPERIENCE", trick:"EXPERTISE = expert + tise = skill so deep you could teach it. EXPERIENCE = just having done something. You can have experience in cooking but expertise in molecular gastronomy.", visual:"🏆 Expertise = mastery level. 📋 Experience = participation level.", example:"I have experience in marketing. | My expertise is in SEO." },
    { id:15, category:"vocabulary", title:"HOLD a degree (formal) vs HAVE a degree", trick:"'HOLD' = you're actively holding it up like a trophy. More formal and impressive. 'Have' is casual. In interviews, 'hold' sounds more polished.", visual:"🏆 HOLD = trophy-holding pose. 👜 HAVE = casually in your bag.", example:"I hold an MBA from IIM. (formal) | I have an MBA. (casual)" },
    { id:16, category:"grammar", title:"DESPITE vs IN SPITE OF", trick:"DESPITE is ALONE (no 'of'). IN SPITE needs 'of' — it's three words and they stay together. Despite = solo. In spite of = always three words together.", visual:"DESPITE = solo traveler 🚶. IN SPITE OF = group of three 👥.", example:"Despite the rain. ✅ | Despite of the rain. ❌ | In spite of the rain. ✅" },
    { id:17, category:"pronunciation", title:"'TH' Sound — Tongue Between Teeth!", trick:"'TH' = Tongue Hug! Put your tongue between your upper and lower teeth and blow air. Like the tongue is being gently bitten. Most languages don't have this — that's why it's hard!", visual:"👅 TH = Tongue Hug (between teeth). No hug = wrong sound.", example:"This (ðɪs) | Three (θriː) | The (ðə) | Think (θɪŋk)" },
    { id:18, category:"vocabulary", title:"FLUENT IN vs FLUENT AT", trick:"FLUENT IN a language — 'IN' the language, swimming in it. Like a fish IN water. 'Fluent at' doesn't exist.", visual:"🐠 Fluent IN English = swimming in the language ocean.", example:"Fluent in Hindi and English. ✅ | Fluent at speaking. ❌" },
    { id:19, category:"grammar", title:"SINCE = Point. FOR = Period.", trick:"SINCE sounds like a clock striking — it marks a SINGLE point. FOR sounds like a forever hum — it covers a STRETCH. 'Since Tuesday' (point). 'For 3 days' (stretch).", visual:"📍 SINCE = pin in a map (one point). 📏 FOR = ruler (length).", example:"Since 2020 | Since Monday | For 5 years | For 3 months" },
    { id:20, category:"grammar", title:"OPEN TO + NOUN/-ING", trick:"OPEN TO = a door that is open TO something entering. What enters? Always a noun or gerund (-ing), never an infinitive. 'Open to ideas' / 'Open to exploring'.", visual:"🚪 OPEN TO → [noun or gerund walks through the door]", example:"Open to relocation. ✅ | Open to relocating. ✅ | Open to relocate. ❌" },
    { id:21, category:"structure", title:"Present-Past-Future Interview Formula", trick:"PPF = Pizza, Pasta, Fruit! Start with what you DO now (fresh pizza), go to how you GOT here (cooked pasta), then where you're GOING (fresh fruit ahead).", visual:"🍕 Present (now) → 🍝 Past (how you got here) → 🍇 Future (where you're going)", example:"'I am X (now) → I came from Y (past) → I want Z (future)'" },
    { id:22, category:"vocabulary", title:"ACCOMPLISH vs ACHIEVE vs COMPLETE", trick:"ACCOMPLISH = big, complex things (projects, goals). ACHIEVE = targets with measurable results (scores, numbers). COMPLETE = finishing tasks (courses, degrees). Match the verb to the size.", visual:"🏛️ Accomplish = big. 🎯 Achieve = targeted. ✅ Complete = tick it off.", example:"I accomplished a difficult migration project. | I achieved 40% growth. | I completed an MBA." },
    { id:23, category:"pronunciation", title:"Stress in 'Experience'", trick:"ex-PER-ience. The PEAR is in the middle — stress on the PEAR. 'I have ex-PEAR-ience.' Imagine biting a juicy pear in the middle of the word.", visual:"ex — 🍐 PEAR — ience. Bite the PEAR.", example:"ex-PER-ience (4 syllables, stress on 2nd)" },
    { id:24, category:"grammar", title:"ENJOY + -ING (Never infinitive)", trick:"ENJOY sounds like a party 🥳 — and at parties, things are HAPPENING (-ing). You enjoy DANCING, not to dance. You enjoy MEETING, not to meet.", visual:"🥳 ENJOY = party = everything is -ING and happening!", example:"I enjoy reading. ✅ | I enjoy to read. ❌ | I enjoy traveling." },
    { id:25, category:"vocabulary", title:"COMMITTED TO vs DEDICATED TO", trick:"COMMITTED = like a marriage vow — deep, formal, long-term. DEDICATED = focused energy on a project or goal — can be shorter-term. Use 'committed' for values, 'dedicated' for tasks.", visual:"💍 Committed = marriage vow (deep). 🎯 Dedicated = target focus.", example:"I am committed to excellence. | I am dedicated to this project." },
    { id:26, category:"structure", title:"The 3Cs of Great Introduction", trick:"3Cs = Clear, Concise, Compelling. Test your intro: 1) Clear — does a stranger understand it? 2) Concise — under 90 seconds? 3) Compelling — does it make them want to know more?", visual:"Clear 🔍 + Concise ✂️ + Compelling 🎣 = Great Intro 🌟", example:"Apply 3Cs to every intro you write or say" },
    { id:27, category:"vocabulary", title:"PROFICIENT IN vs COMPETENT IN vs EXPERT IN", trick:"Ladder of skill: Competent (can do it without help) → Proficient (do it well, efficiently) → Expert (could teach it, solve hard problems). Choose based on your real level!", visual:"🪜 Competent → Proficient → Expert (ladder going up)", example:"Competent in Spanish | Proficient in Python | Expert in machine learning" },
    { id:28, category:"grammar", title:"'I HAVE BEEN working' vs 'I WAS working'", trick:"HAVE BEEN = still happening now (present perfect continuous). WAS = finished (past simple). 'I have been working at TCS' (still there). 'I was working at TCS' (left).", visual:"🏃 HAVE BEEN = still running. 🛑 WAS = stopped.", example:"I have been working here for 3 years. (still here) | I was working there. (no longer)" },
    { id:29, category:"vocabulary", title:"HIRE vs EMPLOY vs RECRUIT", trick:"RECRUIT = find candidates (army style, going out to get them). HIRE = select and bring in. EMPLOY = ongoing state of being on payroll. Recruit → Hire → Employ.", visual:"🎯 Recruit (hunt) → 🤝 Hire (select) → 📋 Employ (ongoing)", example:"We recruit from top colleges. | We hired her last month. | We employ 500 people." },
    { id:30, category:"pronunciation", title:"'v' in 'very', 'work' in 'work'", trick:"'Very' starts with V: lower lip touches upper teeth. 'Work' starts with W: rounded lips, no teeth touch. Practice switching: 'Very well' vs 'Well done.' Mouth shape changes!", visual:"V = 🦷 teeth-lip contact. W = 👄 rounded lips only.", example:"Very / Berry | Vine / Wine | Vest / West | Veil / Wail" },
    { id:31, category:"grammar", title:"DESPITE being alone vs IN SPITE OF needing company", trick:"DESPITE is an introvert — works alone, no 'of' needed. IN SPITE always brings OF as a companion — three's a company!", visual:"😶 Despite (solo). 👬 In spite of (always together).", example:"Despite difficulties. | In spite of difficulties." },
    { id:32, category:"vocabulary", title:"CONTRIBUTION vs DONATION vs INPUT", trick:"CONTRIBUTION = what you add to a group effort (professional). DONATION = money/goods given voluntarily (charity). INPUT = your opinions in a discussion. Use the right one!", visual:"🤝 Contribution = team addition. 💝 Donation = charity. 💬 Input = voice in discussion.", example:"My contribution to the project. | Make a donation. | Your input is valued." },
    { id:33, category:"grammar", title:"'MUCH' vs 'MANY' — MUCH is invisible!", trick:"MANY = you can COUNT them with fingers. MUCH = you CANNOT count it — it's like water. 'Many years' (you can count 1, 2, 3...). 'Much experience' (you can't count experience).", visual:"🖐️ MANY = count on fingers. 💧 MUCH = like water, uncountable.", example:"Many projects | Much experience | Many mistakes | Much progress" },
    { id:34, category:"structure", title:"Hook Formula for Introductions", trick:"HOOK = Surprise + Identity + Promise. Start with something unexpected (surprise), reveal who you are (identity), then hint at what's coming (promise). Makes people lean in.", visual:"🎣 Hook = Surprise + Identity + Promise", example:"'I've failed twice at this. (surprise) I'm Rahul. (identity) Let me tell you what worked. (promise)'" },
    { id:35, category:"vocabulary", title:"RESPONSIBLE FOR vs IN CHARGE OF", trick:"RESPONSIBLE FOR = the duties/tasks that fall under your area. IN CHARGE OF = you are the leader/decision maker. 'I am responsible for data quality' (your duty). 'I am in charge of the data team' (you lead).", visual:"📋 Responsible for = tasks/duties. 👑 In charge of = leadership.", example:"Responsible for reporting. | In charge of 3 analysts." },
    { id:36, category:"grammar", title:"'I AM FROM' vs 'I COME FROM'", trick:"Both are correct for origin, but 'I AM FROM' is simpler and cleaner. 'I COME FROM' adds a tiny sense of movement or journey. In introductions, 'I am from' is more natural.", visual:"🏠 I AM FROM = static home. 🚀 I COME FROM = journey implied.", example:"I am from Jaipur. ✅ | I come from Jaipur. ✅ | Both are fine!" },
    { id:37, category:"vocabulary", title:"SKILL vs ABILITY vs TALENT", trick:"TALENT = born with it (natural). ABILITY = can physically do it. SKILL = learned and practiced. 'I have a talent for music, the ability to learn quickly, and skills in Python.'", visual:"🎁 Talent (born) → 💪 Ability (can do) → 🔧 Skill (practiced)", example:"Natural talent | Physical ability | Professional skill" },
    { id:38, category:"grammar", title:"THE for Unique Things", trick:"Use THE when there's only ONE of something in context: 'the team', 'the project', 'the manager'. If there are MANY of something and you haven't specified which: 'a manager', 'a team'.", visual:"☝️ THE = one unique thing. 🔢 A/AN = one of many.", example:"I lead the team. (specific team) | I want to join a team. (any team)" },
    { id:39, category:"pronunciation", title:"Stress in 'Professional'", trick:"pro-FES-sion-al. The FES is the stressed syllable. Think: 'A professional CONFESSES their PROFESSION.'", visual:"pro — FES — sion — al. Stress on FES.", example:"professional (4 syllables, stress on 2nd)" },
    { id:40, category:"grammar", title:"WAS BORN vs GOT BORN", trick:"'GOT BORN' doesn't exist in English — only 'WAS BORN'. 'Was' is always used. Think: 'I received the gift of birth' — 'received' is past passive = 'was'.", visual:"🎁 Born = received (passive). Receiver always uses 'was'.", example:"I was born in Lucknow. ✅ | I got born in Lucknow. ❌" },
    { id:41, category:"vocabulary", title:"JOIN vs ENTER vs START", trick:"JOIN = become part of an existing group (join a team, join a company). ENTER = physically go in or begin a phase (enter a field, enter a room). START = begin something from zero.", visual:"🤝 Join = join existing. 🚪 Enter = go into a new space. 🏁 Start = begin fresh.", example:"I joined TCS. | I entered the healthcare sector. | I started my own company." },
    { id:42, category:"structure", title:"Name + Role + Hook", trick:"Magic Formula for casual introductions: NAME (who you are) + ROLE (what you do) + HOOK (one surprising/interesting detail). 3 elements in under 20 seconds.", visual:"NAME + ROLE + HOOK = Perfect Casual Intro", example:"'I'm Meera (name), I build AI tools (role), I also run ultramarathons for fun (hook)'" },
    { id:43, category:"grammar", title:"'WHICH LED ME TO' — Bridge Phrase", trick:"Use 'which led me to' to connect your past to your present: 'I failed a job interview → which led me to improve my English → which led me here today.' It shows cause-and-effect journey.", visual:"⛓️ Which led me to = chain link connecting events", example:"I discovered a gap → which led me to start my company." },
    { id:44, category:"vocabulary", title:"POSITION vs POST vs JOB vs ROLE", trick:"JOB = most casual. ROLE = what you functionally do. POSITION = formal, in an organizational chart. POST = very formal, often government. Match to context!", visual:"🏢 Position (org chart) > Role (function) > Job (casual)", example:"I applied for this position. | In my role as manager. | I'm looking for a new job." },
    { id:45, category:"grammar", title:"CURRENTLY for Present Ongoing", trick:"CURRENTLY = right now, at this moment in time. Always pairs with present continuous or present perfect: 'I am currently working on...' or 'I am currently enrolled in...'", visual:"⏰ CURRENTLY = clock pointing to NOW", example:"I am currently pursuing my MBA. | I am currently leading a team of 8." },
    { id:46, category:"vocabulary", title:"LEAD vs MANAGE vs OVERSEE", trick:"LEAD = you inspire and set direction (visionary). MANAGE = you control day-to-day operations. OVERSEE = you have overall responsibility but delegate details. Use all three differently!", visual:"🔭 Lead (vision) → 📋 Manage (day-to-day) → 🦅 Oversee (overview)", example:"I led the project direction. | I managed daily operations. | I oversee 3 departments." },
    { id:47, category:"pronunciation", title:"'Colleague' — Silent UE", trick:"COLLEAGUE sounds like 'col-EEG'. The 'ue' at the end is completely silent — like it fell asleep. 'col' + 'eeg'. Practice: 'My col-eeg is smart.'", visual:"colleague = col-eeg 💤 (the 'ue' is sleeping)", example:"colleague (2 syllables: col-eeg) | league (1 syllable: leeg)" },
    { id:48, category:"grammar", title:"HAVE BEEN TO vs HAVE GONE TO", trick:"HAVE BEEN TO = you went AND came back. 'I have been to Paris' (I'm back now). HAVE GONE TO = you went and you're STILL THERE. 'She has gone to Paris' (she's still there!).", visual:"✈️ Been to = round trip ✈️🔄. Gone to = one way ✈️→", example:"I have been to Japan. (I'm back here) | She has gone to the market. (still there)" },
    { id:49, category:"vocabulary", title:"ENTHUSIASTIC vs PASSIONATE vs EXCITED", trick:"EXCITED = short-term emotion (about an event). ENTHUSIASTIC = active positive energy and involvement. PASSIONATE = deep, long-term, emotional commitment. Use the right intensity.", visual:"😊 Excited → 🙌 Enthusiastic → 🔥 Passionate (intensity increases)", example:"I'm excited about the conference. | I'm enthusiastic about collaboration. | I'm passionate about AI." },
    { id:50, category:"grammar", title:"DESPITE vs ALTHOUGH vs HOWEVER", trick:"DESPITE + noun/gerund (no sentence). ALTHOUGH + complete sentence. HOWEVER = connects two separate sentences (use semicolon or new sentence).", visual:"DESPITE → [noun]. ALTHOUGH → [sentence]. HOWEVER; → [next sentence].", example:"Despite rain (noun). | Although it rained (sentence). | It rained; however, we played." },
    { id:51, category:"vocabulary", title:"OBJECTIVE vs GOAL vs AIM vs TARGET", trick:"TARGET = most specific and measurable. AIM = direction/intention. GOAL = what you want to achieve. OBJECTIVE = specific, often time-bound goal in a plan. Use target for numbers.", visual:"🎯 Target (most specific) → 🥅 Goal → 🧭 Aim → 🗓️ Objective", example:"My target is 30% growth. | My goal is to become a manager. | My aim is to help." },
    { id:52, category:"structure", title:"The Iceberg Introduction", trick:"Your FULL STORY is the iceberg. Your introduction shows only the TIP — the most relevant part. Different contexts = different tips visible. Everything else stays below water.", visual:"🧊 Iceberg = full story. Above water = what you share now.", example:"At a party: show personal tip. At interview: show professional tip. Same iceberg!" },
    { id:53, category:"grammar", title:"INTERESTED IN + GERUND", trick:"GRAMMAR RHYME: 'In' means 'ING!' When you're interested IN something, that something must end in -ING. Think of 'in' + 'ING' going together like twins.", visual:"IN + ING = always together 👯", example:"Interested in learning. | Interested in meeting you. | Interested in joining." },
    { id:54, category:"vocabulary", title:"ACHIEVE vs ACCOMPLISH vs ATTAIN", trick:"ACHIEVE = reach a goal you worked toward (general). ACCOMPLISH = complete a complex task or mission. ATTAIN = reach a standard or status (often academic). All mean success but at different scales.", visual:"✅ Achieve (general) | 🏆 Accomplish (mission) | 🎓 Attain (standard/status)", example:"I achieved my targets. | I accomplished the project. | I attained a distinction." },
    { id:55, category:"pronunciation", title:"'R' After Vowels — Indian vs Standard English", trick:"In Indian English, every 'r' is pronounced. In British English, 'r' after a vowel is often silent: 'car' = 'caa', 'here' = 'heea'. In American English, 'r' is always pronounced but differently from Indian English.", visual:"🇮🇳 Strong R always. 🇬🇧 Silent R after vowels. 🇺🇸 Soft R always.", example:"'Career' — Indian: ca-REER. British: ca-EEa. American: ca-REER (soft R)" },
    { id:56, category:"grammar", title:"BEEN vs GONE — Quick Test", trick:"Quick test: Can you see the person speaking? If YES, they've BEEN somewhere and come back. If NO, they've GONE somewhere and are still there. 'He's gone' = he's not here. 'He's been there' = he came back.", visual:"👀 Can you see them? Been ✅. Can't see them? Gone 🚶", example:"She has gone to Delhi. (still there) | She has been to Delhi. (back now)" },
    { id:57, category:"vocabulary", title:"SPECIALIZE IN vs FOCUS ON vs CONCENTRATE ON", trick:"SPECIALIZE IN = your area of deep expertise (permanent, professional). FOCUS ON = current direction of work (more temporary). CONCENTRATE ON = right now, immediate task. Scale from career to task.", visual:"🔬 Specialize (career) → 🔍 Focus (project) → 🧠 Concentrate (task right now)", example:"I specialize in cardiology. | I focus on client retention. | I concentrate on this presentation." },
    { id:58, category:"structure", title:"'Because I' — Adding WHY to your intro", trick:"Add 'because I' to any credential to transform it from a fact into a story. 'I'm a teacher' → 'I'm a teacher because I believe no child should feel stupid in a classroom.' WHY is always more memorable than WHAT.", visual:"WHAT (fact) + BECAUSE I (why) = STORY 📖", example:"I'm a doctor because... | I build apps because... | I left banking because..." },
    { id:59, category:"grammar", title:"PRESENT PERFECT for Achievements Still Relevant", trick:"Test: Is this achievement STILL relevant/true today? If YES → use present perfect. 'I have published 3 papers' (they still exist). If it was true but is no longer relevant → use simple past.", visual:"🔗 Present perfect = still connected to today. ✂️ Past simple = cut from today.", example:"I have built 5 apps. (relevant now) | I played cricket in school. (past, less relevant)" },
    { id:60, category:"vocabulary", title:"POSITION vs ROLE — One Key Difference", trick:"POSITION = where you sit in an organizational chart (title, hierarchy). ROLE = what you actually DO functionally. 'My position is Senior Manager. My role is to bridge strategy and execution.' Both matter.", visual:"📊 Position = org chart box. ⚙️ Role = actual function/work.", example:"My position: Senior Analyst. | My role: translating data into decisions." }
  ]
};

write('memory-tricks.json', memoryTricks);
console.log('Memory Tricks done!');

/* ═══════════════════════════════════════════════
   11. VOCABULARY TOP-UP (to reach 1000 words)
═══════════════════════════════════════════════ */
const currentVocab = JSON.parse(require('fs').readFileSync(path.join(DIR, 'vocabulary.json'), 'utf8'));
const currentWords = currentVocab.vocabulary || currentVocab.words || [];

const additionalWords = [
  { word:"amiable", hindi:"मिलनसार", partOfSpeech:"adjective", meaning:"friendly and pleasant", example:"She has an amiable personality that makes everyone comfortable.", category:"personality" },
  { word:"articulate", hindi:"स्पष्टवक्ता", partOfSpeech:"adjective/verb", meaning:"able to express ideas clearly and effectively", example:"He is very articulate when presenting complex data.", category:"communication" },
  { word:"assertive", hindi:"दृढ़ता से बोलने वाला", partOfSpeech:"adjective", meaning:"confident and direct in claiming one's rights or opinions", example:"A good leader is assertive without being aggressive.", category:"personality" },
  { word:"attentive", hindi:"ध्यानपूर्वक सुनने वाला", partOfSpeech:"adjective", meaning:"paying close attention", example:"She is an attentive listener, which makes her a great mentor.", category:"personality" },
  { word:"bilingual", hindi:"द्विभाषी", partOfSpeech:"adjective", meaning:"speaking two languages fluently", example:"Being bilingual is an asset in international business.", category:"language" },
  { word:"candid", hindi:"स्पष्टवादी", partOfSpeech:"adjective", meaning:"truthful and straightforward; frank", example:"I appreciate candid feedback from my colleagues.", category:"communication" },
  { word:"catalyst", hindi:"उत्प्रेरक", partOfSpeech:"noun", meaning:"something that causes change or speeds up a process", example:"Her encouragement was the catalyst for my career change.", category:"work" },
  { word:"charismatic", hindi:"आकर्षक व्यक्तित्व वाला", partOfSpeech:"adjective", meaning:"having a powerful personal charm", example:"The charismatic speaker held the audience's attention throughout.", category:"personality" },
  { word:"coherent", hindi:"तार्किक रूप से संगठित", partOfSpeech:"adjective", meaning:"logical and consistent", example:"A good introduction should be coherent and well-structured.", category:"communication" },
  { word:"competent", hindi:"योग्य", partOfSpeech:"adjective", meaning:"having the necessary skill or knowledge", example:"He is a competent engineer with five years of experience.", category:"professional" },
  { word:"concise", hindi:"संक्षिप्त", partOfSpeech:"adjective", meaning:"brief but comprehensive", example:"Keep your introduction concise — under two minutes.", category:"communication" },
  { word:"conscientious", hindi:"कर्तव्यनिष्ठ", partOfSpeech:"adjective", meaning:"taking care to do what is right and to avoid doing harm", example:"She is a conscientious professional who never cuts corners.", category:"personality" },
  { word:"conviction", hindi:"दृढ़ विश्वास", partOfSpeech:"noun", meaning:"a firmly held belief", example:"He spoke with conviction about his mission.", category:"communication" },
  { word:"credibility", hindi:"विश्वसनीयता", partOfSpeech:"noun", meaning:"the quality of being trusted and believed", example:"Credibility is built through consistent results over time.", category:"professional" },
  { word:"delegate", hindi:"सौंपना", partOfSpeech:"verb/noun", meaning:"to assign tasks to others; a representative", example:"Good managers know when to delegate and when to handle things themselves.", category:"leadership" },
  { word:"demeanor", hindi:"व्यवहार", partOfSpeech:"noun", meaning:"outward behavior or bearing", example:"Her calm demeanor puts clients at ease.", category:"personality" },
  { word:"diligent", hindi:"परिश्रमी", partOfSpeech:"adjective", meaning:"showing steady, careful effort", example:"Diligent preparation is the key to any successful interview.", category:"personality" },
  { word:"diplomatic", hindi:"चतुराई से बात करने वाला", partOfSpeech:"adjective", meaning:"tactful in dealing with sensitive situations", example:"A good negotiator is diplomatic under pressure.", category:"communication" },
  { word:"discerning", hindi:"सूझ-बूझ वाला", partOfSpeech:"adjective", meaning:"having good judgment or perception", example:"She is a discerning reader who appreciates nuanced writing.", category:"personality" },
  { word:"distinctive", hindi:"विशिष्ट", partOfSpeech:"adjective", meaning:"characteristic or noteworthy", example:"His distinctive voice makes his presentations memorable.", category:"general" },
  { word:"domain", hindi:"क्षेत्र/विषय", partOfSpeech:"noun", meaning:"a field of activity or knowledge", example:"Data science is his primary domain.", category:"professional" },
  { word:"dynamic", hindi:"गतिशील", partOfSpeech:"adjective", meaning:"positive, energetic, and full of new ideas", example:"We are looking for a dynamic professional to join our team.", category:"personality" },
  { word:"efficacy", hindi:"प्रभावशीलता", partOfSpeech:"noun", meaning:"the ability to produce the desired result", example:"Research proved the efficacy of the new training method.", category:"professional" },
  { word:"eloquent", hindi:"वाक्पटु", partOfSpeech:"adjective", meaning:"fluent and persuasive in speaking or writing", example:"She gave an eloquent speech at the conference.", category:"communication" },
  { word:"empathetic", hindi:"सहानुभूतिपूर्ण", partOfSpeech:"adjective", meaning:"showing the ability to understand others' feelings", example:"An empathetic manager creates a more cohesive team.", category:"personality" },
  { word:"empower", hindi:"सशक्त करना", partOfSpeech:"verb", meaning:"to give authority or power to", example:"I empower my team by trusting them with independent decisions.", category:"leadership" },
  { word:"endeavor", hindi:"प्रयास", partOfSpeech:"noun/verb", meaning:"effort made to achieve something", example:"My lifelong endeavor is to make education accessible.", category:"general" },
  { word:"engage", hindi:"संलग्न करना", partOfSpeech:"verb", meaning:"to involve or attract someone's attention", example:"Great teachers engage students with real-world examples.", category:"communication" },
  { word:"entrepreneurial", hindi:"उद्यमशील", partOfSpeech:"adjective", meaning:"having qualities associated with starting and running businesses", example:"She has an entrepreneurial mindset even in a corporate setting.", category:"professional" },
  { word:"ethical", hindi:"नैतिक", partOfSpeech:"adjective", meaning:"relating to moral principles", example:"Ethical decision-making is non-negotiable in my work.", category:"values" },
  { word:"evolve", hindi:"विकसित होना", partOfSpeech:"verb", meaning:"to develop gradually", example:"My role has evolved from developer to architect over the years.", category:"career" },
  { word:"executive", hindi:"प्रबंधकारी", partOfSpeech:"noun/adjective", meaning:"a senior manager; relating to management", example:"She was promoted to an executive position at 32.", category:"professional" },
  { word:"facilitate", hindi:"सुलभ बनाना", partOfSpeech:"verb", meaning:"to make a process easier", example:"I facilitate workshops for cross-functional teams.", category:"work" },
  { word:"forthright", hindi:"सीधा-सादा", partOfSpeech:"adjective", meaning:"direct and outspoken", example:"He is forthright in his feedback, which I respect.", category:"personality" },
  { word:"foundational", hindi:"आधारभूत", partOfSpeech:"adjective", meaning:"forming an essential base or core", example:"Communication is foundational to every other skill I've built.", category:"professional" },
  { word:"genuine", hindi:"वास्तविक/ईमानदार", partOfSpeech:"adjective", meaning:"truly what it is said to be; authentic", example:"A genuine smile and firm handshake make a great first impression.", category:"personality" },
  { word:"global perspective", hindi:"वैश्विक दृष्टिकोण", partOfSpeech:"noun phrase", meaning:"understanding issues from an international viewpoint", example:"Working with teams in 8 countries gave me a global perspective.", category:"professional" },
  { word:"gravitas", hindi:"गंभीरता/वजन", partOfSpeech:"noun", meaning:"dignity, seriousness, and importance of manner", example:"She speaks with gravitas that immediately commands respect.", category:"communication" },
  { word:"groundbreaking", hindi:"अभूतपूर्व", partOfSpeech:"adjective", meaning:"innovative and pioneering", example:"Their research was groundbreaking in the field of neuroscience.", category:"achievement" },
  { word:"holistic", hindi:"समग्र", partOfSpeech:"adjective", meaning:"considering the whole system, not just parts", example:"I take a holistic approach to project management.", category:"professional" },
  { word:"humility", hindi:"विनम्रता", partOfSpeech:"noun", meaning:"modesty; not thinking too highly of yourself", example:"True leadership requires strength AND humility.", category:"values" },
  { word:"impactful", hindi:"प्रभावशाली", partOfSpeech:"adjective", meaning:"having a major effect", example:"I want to do impactful work that changes real lives.", category:"values" },
  { word:"inclusive", hindi:"समावेशी", partOfSpeech:"adjective", meaning:"not excluding any group", example:"I create inclusive environments where all voices are heard.", category:"values" },
  { word:"industry veteran", hindi:"उद्योग के अनुभवी", partOfSpeech:"noun phrase", meaning:"an experienced professional in a field", example:"As an industry veteran, she mentors emerging professionals.", category:"professional" },
  { word:"innate", hindi:"जन्मजात", partOfSpeech:"adjective", meaning:"naturally present from birth; inborn", example:"She has an innate curiosity that drives continuous learning.", category:"personality" },
  { word:"insightful", hindi:"गहरी अंतर्दृष्टि वाला", partOfSpeech:"adjective", meaning:"having or showing deep understanding", example:"His insightful analysis impressed the board of directors.", category:"professional" },
  { word:"interpersonal", hindi:"पारस्परिक", partOfSpeech:"adjective", meaning:"relating to relationships between people", example:"Strong interpersonal skills are essential for leadership.", category:"communication" },
  { word:"intrinsic", hindi:"आंतरिक", partOfSpeech:"adjective", meaning:"belonging naturally; coming from within", example:"I have intrinsic motivation — I don't need constant supervision.", category:"personality" },
  { word:"jurisdiction", hindi:"अधिकार क्षेत्र", partOfSpeech:"noun", meaning:"the official power to make legal decisions", example:"My work spans multiple legal jurisdictions across Asia.", category:"legal/professional" },
  { word:"keen", hindi:"उत्सुक/तेज", partOfSpeech:"adjective", meaning:"enthusiastic; sharp", example:"I am keen to contribute to your team's goals.", category:"general" },
  { word:"lateral", hindi:"पार्श्विक/बराबरी का", partOfSpeech:"adjective", meaning:"sideways; to/from the side; non-hierarchical", example:"I made a lateral move from finance to operations for growth.", category:"career" },
  { word:"leadership philosophy", hindi:"नेतृत्व दर्शन", partOfSpeech:"noun phrase", meaning:"one's beliefs and approach to leading others", example:"My leadership philosophy centers on trust and transparency.", category:"leadership" },
  { word:"leverage", hindi:"उत्तोलन/फायदा उठाना", partOfSpeech:"verb/noun", meaning:"use something to its maximum advantage", example:"I leverage my cross-industry experience to solve novel problems.", category:"professional" },
  { word:"lifelong learner", hindi:"जीवन भर सीखने वाला", partOfSpeech:"noun phrase", meaning:"someone committed to continuous learning throughout life", example:"I consider myself a lifelong learner — I've taken courses in 6 different fields.", category:"values" },
  { word:"mandate", hindi:"आदेश/जनादेश", partOfSpeech:"noun/verb", meaning:"an official instruction or authority", example:"My mandate is to double our customer base in 18 months.", category:"professional" },
  { word:"meticulous", hindi:"अति सूक्ष्म/सावधान", partOfSpeech:"adjective", meaning:"showing extreme attention to detail", example:"She is meticulous in her documentation, which has saved us from many errors.", category:"personality" },
  { word:"mindful", hindi:"सावधान/जागरूक", partOfSpeech:"adjective", meaning:"conscious or aware of something", example:"I am mindful of the cultural differences within my global team.", category:"values" },
  { word:"multifaceted", hindi:"बहुआयामी", partOfSpeech:"adjective", meaning:"having many different aspects or elements", example:"My role is multifaceted — I wear several hats daily.", category:"work" },
  { word:"navigate", hindi:"नेविगेट करना/मार्ग निकालना", partOfSpeech:"verb", meaning:"find one's way through a complex situation", example:"I have navigated 3 major industry disruptions in my career.", category:"professional" },
  { word:"network effect", hindi:"नेटवर्क प्रभाव", partOfSpeech:"noun phrase", meaning:"a product/service becoming more valuable as more people use it", example:"Understanding the network effect helped me scale the platform.", category:"business" },
  { word:"nuanced", hindi:"सूक्ष्म अंतर वाला", partOfSpeech:"adjective", meaning:"characterized by subtle distinctions", example:"Her nuanced understanding of market dynamics is exceptional.", category:"professional" },
  { word:"objective-driven", hindi:"लक्ष्य-केंद्रित", partOfSpeech:"adjective", meaning:"motivated by specific measurable goals", example:"I am objective-driven — all my decisions tie back to measurable outcomes.", category:"professional" },
  { word:"outgoing", hindi:"मिलनसार/खुशमिज़ाज", partOfSpeech:"adjective", meaning:"friendly and socially confident", example:"Her outgoing personality makes her excellent at client relations.", category:"personality" },
  { word:"paradigm shift", hindi:"दृष्टिकोण में बड़ा बदलाव", partOfSpeech:"noun phrase", meaning:"a fundamental change in approach", example:"Remote work caused a paradigm shift in how we think about productivity.", category:"business" },
  { word:"perceptive", hindi:"कुशाग्र बुद्धि वाला", partOfSpeech:"adjective", meaning:"having or showing a deep understanding", example:"A perceptive manager notices team morale issues before they escalate.", category:"personality" },
  { word:"perseverance", hindi:"लगन/दृढ़ता", partOfSpeech:"noun", meaning:"persistence despite difficulties", example:"My biggest strength is perseverance — I don't give up easily.", category:"values" },
  { word:"pivot", hindi:"धुरी/दिशा बदलना", partOfSpeech:"verb/noun", meaning:"to change direction; a turning point", example:"I pivoted from law to tech after discovering my passion for coding.", category:"career" },
  { word:"pragmatic", hindi:"व्यावहारिक", partOfSpeech:"adjective", meaning:"dealing with situations sensibly and realistically", example:"I take a pragmatic approach — I focus on what's achievable.", category:"personality" },
  { word:"proactive", hindi:"पहल करने वाला", partOfSpeech:"adjective", meaning:"creating or controlling a situation rather than responding to it", example:"I am proactive — I identify problems before they become crises.", category:"personality" },
  { word:"proficiency", hindi:"दक्षता/निपुणता", partOfSpeech:"noun", meaning:"high degree of skill or competence", example:"I have proficiency in Python, R, and Tableau.", category:"professional" },
  { word:"prolific", hindi:"अति उत्पादक", partOfSpeech:"adjective", meaning:"producing a large volume of high-quality work", example:"She is a prolific writer who publishes weekly on LinkedIn.", category:"professional" },
  { word:"rapport", hindi:"आपसी समझ/तालमेल", partOfSpeech:"noun", meaning:"a close relationship of mutual trust", example:"I quickly build rapport with clients through active listening.", category:"communication" },
  { word:"resilient", hindi:"लचीला/मजबूत", partOfSpeech:"adjective", meaning:"able to recover quickly from difficulties", example:"A resilient professional grows stronger from every setback.", category:"personality" },
  { word:"resourceful", hindi:"संसाधन-कुशल", partOfSpeech:"adjective", meaning:"able to find clever ways to overcome difficulties", example:"Being resourceful is critical when budgets are tight.", category:"personality" },
  { word:"rigorous", hindi:"कठोर/सख्त", partOfSpeech:"adjective", meaning:"extremely thorough and careful", example:"I follow a rigorous process for quality assurance.", category:"professional" },
  { word:"scalable", hindi:"विस्तार योग्य", partOfSpeech:"adjective", meaning:"able to be expanded to handle growth", example:"I build scalable systems that can grow with the company.", category:"technology" },
  { word:"self-starter", hindi:"स्वप्रेरित व्यक्ति", partOfSpeech:"noun", meaning:"a person who is motivated to work without needing supervision", example:"I am a self-starter — I've launched three projects independently.", category:"professional" },
  { word:"stakeholder management", hindi:"हितधारक प्रबंधन", partOfSpeech:"noun phrase", meaning:"the process of managing relationships with those affected by a project", example:"Effective stakeholder management is essential for project success.", category:"professional" },
  { word:"steadfast", hindi:"दृढ़/अटल", partOfSpeech:"adjective", meaning:"unwavering; resolutely firm", example:"Her steadfast commitment to quality earned her team's trust.", category:"personality" },
  { word:"strategic thinker", hindi:"रणनीतिक सोच रखने वाला", partOfSpeech:"noun phrase", meaning:"someone who thinks long-term about plans and their implications", example:"A strategic thinker sees connections others miss.", category:"professional" },
  { word:"synthesize", hindi:"संश्लेषण करना", partOfSpeech:"verb", meaning:"combine elements into a coherent whole", example:"I synthesize data from multiple sources to build the full picture.", category:"analytical" },
  { word:"tenacious", hindi:"दृढ़निश्चयी", partOfSpeech:"adjective", meaning:"holding firmly to something; persistent", example:"She is tenacious in pursuing solutions, even for the hardest problems.", category:"personality" },
  { word:"thought leadership", hindi:"विचार नेतृत्व", partOfSpeech:"noun phrase", meaning:"sharing expert insights that influence others in a field", example:"She built her thought leadership through 200+ blog articles.", category:"professional" },
  { word:"transformative", hindi:"रूपांतरकारी", partOfSpeech:"adjective", meaning:"causing major change or development", example:"The training program was transformative for my career.", category:"general" },
  { word:"transparent", hindi:"पारदर्शी", partOfSpeech:"adjective", meaning:"honest and open, with nothing hidden", example:"I value transparent communication in every relationship.", category:"values" },
  { word:"unprecedented", hindi:"अभूतपूर्व", partOfSpeech:"adjective", meaning:"never done or known before", example:"The pandemic caused unprecedented disruption in every industry.", category:"general" },
  { word:"versatile", hindi:"बहुमुखी प्रतिभा का धनी", partOfSpeech:"adjective", meaning:"able to adapt to many different activities or roles", example:"I am a versatile professional — I've worked across 4 different industries.", category:"professional" },
  { word:"visionary", hindi:"दूरदर्शी", partOfSpeech:"noun/adjective", meaning:"thinking about the future with imagination and wisdom", example:"She is a visionary leader who saw the AI wave before anyone else.", category:"leadership" },
  { word:"vocal", hindi:"मुखर", partOfSpeech:"adjective", meaning:"expressing opinions openly and freely", example:"I am vocal about my ideas in team meetings.", category:"communication" },
  { word:"work ethic", hindi:"काम के प्रति नैतिकता", partOfSpeech:"noun phrase", meaning:"a belief in the moral value of hard work", example:"My strong work ethic was instilled by watching my parents.", category:"values" },
  { word:"zealous", hindi:"उत्साही/जोशीला", partOfSpeech:"adjective", meaning:"having great energy or enthusiasm", example:"He is zealous about continuous improvement in every project.", category:"personality" },
  { word:"acumen", hindi:"कुशाग्रता/तीक्ष्ण बुद्धि", partOfSpeech:"noun", meaning:"the ability to make good judgments and quick decisions", example:"Her business acumen has been honed over 20 years in the industry.", category:"professional" },
  { word:"adept", hindi:"कुशल/दक्ष", partOfSpeech:"adjective", meaning:"very skilled or proficient at something", example:"I am adept at managing multiple projects simultaneously.", category:"professional" },
  { word:"affable", hindi:"मिलनसार/सौम्य", partOfSpeech:"adjective", meaning:"friendly, good-natured, easy to talk to", example:"His affable nature makes him a favorite among clients.", category:"personality" },
  { word:"agile", hindi:"फुर्तीला/चुस्त", partOfSpeech:"adjective", meaning:"able to move or adapt quickly (also a work methodology)", example:"I work in an agile environment where priorities shift weekly.", category:"professional" },
  { word:"alacrity", hindi:"तत्परता/उत्साह", partOfSpeech:"noun", meaning:"brisk and cheerful readiness", example:"She accepted every new challenge with alacrity.", category:"personality" },
  { word:"ambitious", hindi:"महत्वाकांक्षी", partOfSpeech:"adjective", meaning:"having a strong desire to succeed", example:"I am ambitious but realistic — I set bold goals with clear plans.", category:"personality" },
  { word:"analytical", hindi:"विश्लेषणात्मक", partOfSpeech:"adjective", meaning:"using logical reasoning to examine data or problems", example:"My analytical approach helps me find patterns others miss.", category:"professional" },
  { word:"benchmark", hindi:"मानक/मापदंड", partOfSpeech:"noun/verb", meaning:"a standard or reference point; to measure against a standard", example:"I benchmarked our performance against industry leaders.", category:"professional" },
  { word:"breadth", hindi:"विस्तार/फैलाव", partOfSpeech:"noun", meaning:"the range or extent of something", example:"The breadth of my experience covers marketing, operations, and finance.", category:"professional" },
  { word:"caliber", hindi:"स्तर/योग्यता", partOfSpeech:"noun", meaning:"the quality or ability of a person", example:"We hire professionals of the highest caliber.", category:"professional" },
  { word:"candor", hindi:"सत्यनिष्ठा/स्पष्टवादिता", partOfSpeech:"noun", meaning:"the quality of being open and honest", example:"I appreciate leaders who speak with candor.", category:"values" },
  { word:"circumstantial", hindi:"परिस्थितियों पर निर्भर", partOfSpeech:"adjective", meaning:"relating to or dependent on circumstances", example:"The timing of my career change was circumstantial, not planned.", category:"general" },
  { word:"clarity", hindi:"स्पष्टता", partOfSpeech:"noun", meaning:"the quality of being clear and easy to understand", example:"I communicate with clarity so my team always knows what's expected.", category:"communication" },
  { word:"cohesive", hindi:"एकजुट/संगठित", partOfSpeech:"adjective", meaning:"forming a unified whole", example:"A cohesive team produces far better results than a brilliant but disconnected one.", category:"teamwork" },
  { word:"comprehensive", hindi:"व्यापक", partOfSpeech:"adjective", meaning:"complete and including all relevant areas", example:"I provide comprehensive analysis before making any recommendation.", category:"professional" },
  { word:"congruent", hindi:"सुसंगत", partOfSpeech:"adjective", meaning:"in agreement or harmony", example:"My values and my company's mission are perfectly congruent.", category:"values" },
  { word:"constructive", hindi:"रचनात्मक/उपयोगी", partOfSpeech:"adjective", meaning:"helpful and intended to improve something", example:"I always give constructive criticism, not just complaints.", category:"communication" },
  { word:"conviction", hindi:"दृढ़ विश्वास", partOfSpeech:"noun", meaning:"a firm belief", example:"I speak with conviction — I only argue for what I truly believe.", category:"communication" },
  { word:"cross-functional", hindi:"अंतर-कार्यात्मक", partOfSpeech:"adjective", meaning:"involving several different departments or functions", example:"I have experience leading cross-functional teams across sales, tech, and ops.", category:"professional" },
  { word:"cultivate", hindi:"विकसित करना/पोषित करना", partOfSpeech:"verb", meaning:"to try to develop and improve something", example:"I consciously cultivate relationships that are mutually beneficial.", category:"general" },
  { word:"cutting-edge", hindi:"अत्याधुनिक", partOfSpeech:"adjective", meaning:"highly advanced; at the forefront of development", example:"We use cutting-edge technology to solve old problems.", category:"technology" },
  { word:"decisive", hindi:"निर्णायक", partOfSpeech:"adjective", meaning:"having the ability to make decisions quickly and firmly", example:"In crisis situations, leaders must be decisive, not hesitant.", category:"leadership" },
  { word:"depth", hindi:"गहराई", partOfSpeech:"noun", meaning:"the extent to which something is detailed or profound", example:"The depth of her knowledge in finance is remarkable.", category:"professional" },
  { word:"derive", hindi:"प्राप्त करना/निकालना", partOfSpeech:"verb", meaning:"to obtain something from a source", example:"I derive satisfaction not just from results, but from the process.", category:"general" },
  { word:"differentiate", hindi:"अंतर करना/अलग पहचान बनाना", partOfSpeech:"verb", meaning:"to be or become different; to make oneself stand out", example:"What differentiates me is my combination of technical and creative skills.", category:"professional" },
  { word:"diligence", hindi:"परिश्रम/लगन", partOfSpeech:"noun", meaning:"careful and persistent work or effort", example:"Success in this field demands diligence and attention to detail.", category:"values" },
  { word:"discrepancy", hindi:"विसंगति/असमानता", partOfSpeech:"noun", meaning:"a lack of consistency or agreement", example:"I noticed a discrepancy in the data that others had missed.", category:"analytical" },
  { word:"distinguish", hindi:"पहचानना/अलग करना", partOfSpeech:"verb", meaning:"to recognize as different; to excel", example:"She distinguished herself by delivering ahead of every deadline.", category:"professional" },
  { word:"drive", hindi:"जुनून/ऊर्जा", partOfSpeech:"noun/verb", meaning:"strong motivation; to motivate strongly", example:"What drives me is the desire to create meaningful change.", category:"values" },
  { word:"ecosystem", hindi:"पारिस्थितिकी तंत्र", partOfSpeech:"noun", meaning:"a complex network of organizations or activities", example:"I have worked extensively within the startup ecosystem.", category:"business" },
  { word:"effective", hindi:"प्रभावी", partOfSpeech:"adjective", meaning:"producing the desired result", example:"Effective communication is the foundation of any successful team.", category:"professional" },
  { word:"empowerment", hindi:"सशक्तिकरण", partOfSpeech:"noun", meaning:"giving power or authority to someone", example:"I believe in the empowerment of women in leadership roles.", category:"values" },
  { word:"encapsulate", hindi:"सार रूप में प्रस्तुत करना", partOfSpeech:"verb", meaning:"to express the essential features of something concisely", example:"If I had to encapsulate my career in one word, it would be 'relentless'.", category:"communication" },
  { word:"enthusiasm", hindi:"उत्साह", partOfSpeech:"noun", meaning:"intense and eager enjoyment or interest", example:"My enthusiasm for this field has never faded in 12 years.", category:"personality" },
  { word:"entrepreneurship", hindi:"उद्यमशीलता", partOfSpeech:"noun", meaning:"the activity of setting up and running businesses", example:"Entrepreneurship taught me resilience in ways no job ever could.", category:"career" },
  { word:"exemplary", hindi:"अनुकरणीय", partOfSpeech:"adjective", meaning:"serving as a desirable model; outstanding", example:"Her exemplary work ethic motivates everyone around her.", category:"professional" },
  { word:"expedite", hindi:"तेज़ी से करना", partOfSpeech:"verb", meaning:"to make something happen sooner", example:"I expedited the process by removing 3 unnecessary approval steps.", category:"work" },
  { word:"expertise", hindi:"विशेषज्ञता", partOfSpeech:"noun", meaning:"expert skill or knowledge", example:"My area of expertise is product-led growth.", category:"professional" },
  { word:"exposure", hindi:"अनुभव/परिचय", partOfSpeech:"noun", meaning:"experience of a wide range of situations", example:"Working abroad gave me exposure to different business cultures.", category:"professional" },
  { word:"foresight", hindi:"दूरदृष्टि", partOfSpeech:"noun", meaning:"the ability to predict what will happen", example:"Good business leaders have the foresight to see market shifts early.", category:"leadership" },
  { word:"formidable", hindi:"दुर्जेय/प्रभावशाली", partOfSpeech:"adjective", meaning:"inspiring fear or respect through being impressively capable", example:"She built a formidable reputation in just three years.", category:"professional" },
  { word:"forthcoming", hindi:"आने वाला/खुलकर बात करने वाला", partOfSpeech:"adjective", meaning:"about to happen; willing to disclose information", example:"I am forthcoming about challenges rather than hiding them.", category:"communication" },
  { word:"framework", hindi:"ढाँचा/रूपरेखा", partOfSpeech:"noun", meaning:"a basic structure underlying a system or concept", example:"I use a structured framework to evaluate every business decision.", category:"professional" },
  { word:"frontline", hindi:"अग्रिम पंक्ति", partOfSpeech:"adjective", meaning:"at the front or forefront of an activity", example:"I spent my first year in frontline customer service — it shaped everything.", category:"work" },
  { word:"generalist", hindi:"सर्वज्ञाता", partOfSpeech:"noun", meaning:"a person with broad knowledge in multiple areas", example:"I am a generalist who can go deep when needed.", category:"professional" },
  { word:"groundwork", hindi:"आधारभूत कार्य", partOfSpeech:"noun", meaning:"the preliminary or basic work needed for a project", example:"I laid the groundwork for our data infrastructure in year one.", category:"work" },
  { word:"harmonize", hindi:"तालमेल बिठाना", partOfSpeech:"verb", meaning:"to bring into agreement or consistency", example:"My role is to harmonize the vision of leadership with the reality of execution.", category:"work" },
  { word:"high-impact", hindi:"उच्च प्रभाव वाला", partOfSpeech:"adjective", meaning:"producing significant results", example:"I focus on high-impact work rather than busy work.", category:"professional" },
  { word:"horizon", hindi:"क्षितिज/भविष्य", partOfSpeech:"noun", meaning:"the limit of a person's knowledge or experience", example:"This role will expand my professional horizons significantly.", category:"career" },
  { word:"hypothesis", hindi:"परिकल्पना", partOfSpeech:"noun", meaning:"a proposed explanation based on limited evidence", example:"I test every hypothesis before making a major recommendation.", category:"analytical" },
  { word:"identify", hindi:"पहचानना", partOfSpeech:"verb", meaning:"to recognize or establish the identity of something", example:"I can identify patterns in complex datasets very quickly.", category:"analytical" },
  { word:"impact-driven", hindi:"प्रभाव-उन्मुख", partOfSpeech:"adjective", meaning:"motivated primarily by creating positive results", example:"I am impact-driven — titles and perks matter less to me than outcomes.", category:"values" },
  { word:"implement", hindi:"लागू करना", partOfSpeech:"verb", meaning:"to put into effect", example:"I not only design solutions — I implement them end-to-end.", category:"work" },
  { word:"impressive", hindi:"प्रभावशाली", partOfSpeech:"adjective", meaning:"evoking admiration through being notably large, better, or more skilled", example:"She has an impressive track record of delivering complex projects.", category:"professional" },
  { word:"incubate", hindi:"ऊष्मायन करना/पोषित करना", partOfSpeech:"verb", meaning:"to develop slowly toward maturity", example:"Our lab has incubated 12 startups in the past 4 years.", category:"business" },
  { word:"indispensable", hindi:"अपरिहार्य", partOfSpeech:"adjective", meaning:"absolutely necessary or essential", example:"I aim to be indispensable by solving problems others don't even see yet.", category:"professional" },
  { word:"influence", hindi:"प्रभाव", partOfSpeech:"noun/verb", meaning:"the power to affect decisions or actions", example:"Great leaders lead through influence, not authority.", category:"leadership" },
  { word:"initiative", hindi:"पहल/आरंभ", partOfSpeech:"noun", meaning:"the ability to assess and act independently", example:"I took the initiative to build a new onboarding system that reduced errors by 60%.", category:"professional" },
  { word:"innovate", hindi:"नवाचार करना", partOfSpeech:"verb", meaning:"to introduce new ideas or methods", example:"I constantly look for ways to innovate within existing constraints.", category:"work" },
  { word:"insight", hindi:"अंतर्दृष्टि", partOfSpeech:"noun", meaning:"a deep or accurate understanding", example:"My analysis provided insights that changed the company's product roadmap.", category:"professional" },
  { word:"inspire", hindi:"प्रेरित करना", partOfSpeech:"verb", meaning:"to fill someone with motivation and enthusiasm", example:"Great introductions inspire the listener to want to know more.", category:"leadership" },
  { word:"integrate", hindi:"एकीकृत करना", partOfSpeech:"verb", meaning:"to combine into a whole", example:"I integrated three separate teams into one cohesive unit.", category:"leadership" },
  { word:"interdisciplinary", hindi:"अंतरअनुशासनात्मक", partOfSpeech:"adjective", meaning:"relating to more than one branch of knowledge", example:"I have an interdisciplinary background in engineering and business.", category:"professional" },
  { word:"iteration", hindi:"पुनरावृत्ति/चरण", partOfSpeech:"noun", meaning:"a process of repeating to achieve improvement", example:"We run three iterations of testing before every product launch.", category:"work" },
  { word:"judgment", hindi:"निर्णय/समझ", partOfSpeech:"noun", meaning:"the ability to form sound opinions or decisions", example:"Sound judgment is more valuable than any technical skill.", category:"professional" },
  { word:"leverage", hindi:"लाभ उठाना", partOfSpeech:"verb/noun", meaning:"use something to maximum advantage", example:"I leverage data to make decisions that others make on instinct.", category:"professional" },
  { word:"longitudinal", hindi:"दीर्घकालिक/अनुदैर्ध्य", partOfSpeech:"adjective", meaning:"over a long period; running lengthwise", example:"A longitudinal study of 5 years shows the true impact of the intervention.", category:"research" },
  { word:"mentorship", hindi:"मार्गदर्शन", partOfSpeech:"noun", meaning:"guidance provided by an experienced person", example:"I have benefited from great mentorship throughout my career.", category:"professional" },
  { word:"meticulous", hindi:"अत्यंत सावधान", partOfSpeech:"adjective", meaning:"showing great attention to detail", example:"I am meticulous about data quality — every number must be verified.", category:"personality" },
  { word:"milestone", hindi:"मील का पत्थर/उपलब्धि", partOfSpeech:"noun", meaning:"an important event in the development of something", example:"Getting promoted in year 2 was my first major career milestone.", category:"career" },
  { word:"mindset", hindi:"मानसिकता", partOfSpeech:"noun", meaning:"the established set of attitudes held by someone", example:"A growth mindset is the foundation of every achievement I've made.", category:"values" },
  { word:"mission-driven", hindi:"लक्ष्य-प्रेरित", partOfSpeech:"adjective", meaning:"motivated by a sense of purpose or mission", example:"I only work for mission-driven organizations that want to change something.", category:"values" },
  { word:"narrative", hindi:"कथा/कहानी", partOfSpeech:"noun", meaning:"a spoken or written account; the story of your journey", example:"Your career narrative is more powerful than your resume.", category:"communication" },
  { word:"niche", hindi:"विशेष क्षेत्र", partOfSpeech:"noun/adjective", meaning:"a specialized segment of a market or field", example:"I have carved a niche in sustainable packaging design.", category:"professional" },
  { word:"objective", hindi:"उद्देश्य/वस्तुनिष्ठ", partOfSpeech:"noun/adjective", meaning:"a goal; not influenced by personal feelings", example:"My objective is to become a CTO within the next 7 years.", category:"career" },
  { word:"open-minded", hindi:"खुले विचारों वाला", partOfSpeech:"adjective", meaning:"willing to consider new ideas", example:"I am open-minded and genuinely enjoy being proven wrong.", category:"personality" },
  { word:"optimize", hindi:"अनुकूलित करना", partOfSpeech:"verb", meaning:"to make the best or most effective use of", example:"I optimize processes by identifying bottlenecks and removing them.", category:"work" },
  { word:"outcome", hindi:"परिणाम", partOfSpeech:"noun", meaning:"the result of an action or process", example:"My focus is always on outcomes, not just activities.", category:"professional" },
  { word:"ownership", hindi:"स्वामित्व/जिम्मेदारी", partOfSpeech:"noun", meaning:"taking responsibility for something", example:"I take full ownership of my projects — both successes and failures.", category:"values" },
  { word:"parallel", hindi:"समांतर", partOfSpeech:"adjective/noun", meaning:"similar; occurring at the same time", example:"My two passions — technology and education — are not parallel tracks; they converge.", category:"general" },
  { word:"peak performance", hindi:"चरम प्रदर्शन", partOfSpeech:"noun phrase", meaning:"performing at one's highest possible level", example:"I design my workday to enable peak performance in the morning hours.", category:"professional" },
  { word:"persistent", hindi:"लगातार/दृढ़ रहने वाला", partOfSpeech:"adjective", meaning:"continuing firmly despite obstacles", example:"Being persistent has helped me solve problems others abandoned.", category:"personality" },
  { word:"perspective", hindi:"दृष्टिकोण", partOfSpeech:"noun", meaning:"a particular attitude or point of view", example:"My diverse background gives me a unique perspective on problems.", category:"professional" },
  { word:"pioneering", hindi:"अग्रदूत", partOfSpeech:"adjective", meaning:"introducing new ideas or methods", example:"She did pioneering research in computational biology.", category:"professional" },
  { word:"portfolio", hindi:"पोर्टफोलियो", partOfSpeech:"noun", meaning:"a collection of work; range of investments or products", example:"My design portfolio includes work for 40+ clients across 6 countries.", category:"professional" },
  { word:"potential", hindi:"क्षमता/संभावना", partOfSpeech:"noun/adjective", meaning:"having or showing the capacity to become something", example:"I am eager to fulfill my potential in a challenging role.", category:"career" },
  { word:"pragmatism", hindi:"व्यावहारिकता", partOfSpeech:"noun", meaning:"a practical, real-world approach to problems", example:"I balance idealism with pragmatism — I dream big and plan carefully.", category:"values" },
  { word:"precision", hindi:"परिशुद्धता", partOfSpeech:"noun", meaning:"exactness and accuracy", example:"Precision in financial analysis is non-negotiable.", category:"professional" },
  { word:"prioritize", hindi:"प्राथमिकता देना", partOfSpeech:"verb", meaning:"to treat something as more important than others", example:"I prioritize high-impact tasks, especially in the morning.", category:"work" },
  { word:"proponent", hindi:"समर्थक", partOfSpeech:"noun", meaning:"a person who advocates a cause or theory", example:"I am a strong proponent of data-driven decision making.", category:"values" },
  { word:"prototype", hindi:"प्रोटोटाइप", partOfSpeech:"noun/verb", meaning:"an early sample or model; to create a prototype", example:"I prototype before building — it saves 10x the effort.", category:"work" },
  { word:"proven", hindi:"सिद्ध", partOfSpeech:"adjective", meaning:"demonstrated to be true or effective", example:"I have a proven track record in customer acquisition.", category:"professional" },
  { word:"purposeful", hindi:"उद्देश्यपूर्ण", partOfSpeech:"adjective", meaning:"having or showing determination and purpose", example:"Every career decision I make is purposeful — nothing is accidental.", category:"values" },
  { word:"quantify", hindi:"मात्रात्मक रूप से व्यक्त करना", partOfSpeech:"verb", meaning:"to express or measure as a quantity", example:"I always quantify my achievements — numbers make impact concrete.", category:"professional" },
  { word:"reframe", hindi:"नए नजरिए से देखना", partOfSpeech:"verb", meaning:"to present in a new or different way", example:"I can reframe challenges as opportunities in client conversations.", category:"communication" },
  { word:"relevant", hindi:"प्रासंगिक", partOfSpeech:"adjective", meaning:"closely connected or appropriate to what is being discussed", example:"Your introduction should always be relevant to your audience.", category:"communication" },
  { word:"responsive", hindi:"संवेदनशील/तुरंत प्रतिक्रिया देने वाला", partOfSpeech:"adjective", meaning:"reacting quickly and positively", example:"I am highly responsive to feedback and act on it within 24 hours.", category:"professional" },
  { word:"robust", hindi:"मजबूत/ठोस", partOfSpeech:"adjective", meaning:"strong and effective in all situations", example:"We need a robust strategy that can withstand market volatility.", category:"business" },
  { word:"role model", hindi:"आदर्श व्यक्ति", partOfSpeech:"noun phrase", meaning:"a person whose behavior others emulate", example:"My father was my first role model — he taught me discipline.", category:"personal" },
  { word:"scope", hindi:"दायरा/गुंजाइश", partOfSpeech:"noun", meaning:"the extent of the area or subject matter", example:"The scope of my responsibilities expanded significantly in year two.", category:"work" },
  { word:"seamless", hindi:"निर्बाध", partOfSpeech:"adjective", meaning:"smooth and without interruption", example:"I specialize in seamless system integration.", category:"professional" },
  { word:"self-awareness", hindi:"आत्म-जागरूकता", partOfSpeech:"noun", meaning:"conscious knowledge of one's own character and feelings", example:"Self-awareness is the foundation of any authentic introduction.", category:"values" },
  { word:"shareholder value", hindi:"शेयरधारक मूल्य", partOfSpeech:"noun phrase", meaning:"the value delivered to shareholders by a company", example:"My decisions consistently created shareholder value.", category:"business" },
  { word:"showcase", hindi:"प्रदर्शित करना", partOfSpeech:"verb/noun", meaning:"to exhibit prominently", example:"This project was an opportunity to showcase my full range of skills.", category:"professional" },
  { word:"situational", hindi:"परिस्थितिजन्य", partOfSpeech:"adjective", meaning:"relating to or determined by a situation", example:"I adapt my communication style to be situational.", category:"communication" },
  { word:"solution-oriented", hindi:"समाधान-उन्मुख", partOfSpeech:"adjective", meaning:"focused on finding solutions rather than dwelling on problems", example:"I am solution-oriented — I never bring a problem without a proposed fix.", category:"personality" },
  { word:"span", hindi:"फैलाना/अवधि", partOfSpeech:"verb/noun", meaning:"to extend over a period or range", example:"My experience spans technology, finance, and social enterprise.", category:"professional" },
  { word:"stakeholder", hindi:"हितधारक", partOfSpeech:"noun", meaning:"a person with an interest in an organization", example:"I manage relationships with 12 key stakeholders across 3 continents.", category:"professional" },
  { word:"strategy", hindi:"रणनीति", partOfSpeech:"noun", meaning:"a plan designed to achieve a goal", example:"I develop strategy by combining market data with customer insight.", category:"business" },
  { word:"streamline", hindi:"सुव्यवस्थित करना", partOfSpeech:"verb", meaning:"to make more efficient and effective", example:"I streamlined our hiring process, reducing time-to-hire by 40%.", category:"work" },
  { word:"subject matter expert", hindi:"विषय-विशेषज्ञ", partOfSpeech:"noun phrase", meaning:"a person with deep knowledge in a specific field", example:"I am the subject matter expert in cloud security on my team.", category:"professional" },
  { word:"sustainable", hindi:"टिकाऊ", partOfSpeech:"adjective", meaning:"able to be maintained over the long term", example:"I build sustainable processes that don't break when I leave.", category:"professional" },
  { word:"synergy", hindi:"तालमेल/समन्वयात्मक शक्ति", partOfSpeech:"noun", meaning:"the combined effect greater than the sum of parts", example:"The synergy between design and engineering on my team is exceptional.", category:"business" },
  { word:"systematic", hindi:"व्यवस्थित", partOfSpeech:"adjective", meaning:"done according to a fixed plan or system", example:"I take a systematic approach to every problem I encounter.", category:"personality" },
  { word:"tactical", hindi:"रणनीतिक/व्यावहारिक", partOfSpeech:"adjective", meaning:"relating to plans for specific short-term goals", example:"I balance strategic thinking with tactical execution.", category:"professional" },
  { word:"tangible", hindi:"ठोस/मूर्त", partOfSpeech:"adjective", meaning:"clear and definite; able to be touched", example:"I focus on tangible results, not just abstract plans.", category:"professional" },
  { word:"tenure", hindi:"कार्यकाल", partOfSpeech:"noun", meaning:"the period during which someone holds a position", example:"During my tenure at Deloitte, I led 8 major client engagements.", category:"professional" },
  { word:"thorough", hindi:"संपूर्ण/विस्तृत", partOfSpeech:"adjective", meaning:"complete and careful in all aspects", example:"I am thorough in my research before presenting any recommendation.", category:"professional" },
  { word:"thought-provoking", hindi:"विचार जागृत करने वाला", partOfSpeech:"adjective", meaning:"stimulating careful thought", example:"She gave a thought-provoking talk on the ethics of AI.", category:"communication" },
  { word:"thrive", hindi:"फलना-फूलना", partOfSpeech:"verb", meaning:"to grow and prosper", example:"I thrive in fast-paced environments that reward initiative.", category:"work" },
  { word:"traction", hindi:"गति/पकड़", partOfSpeech:"noun", meaning:"progress; the grip of something", example:"Our startup gained significant traction within the first 6 months.", category:"business" },
  { word:"track record", hindi:"सिद्ध इतिहास", partOfSpeech:"noun phrase", meaning:"a record of past achievements or failures", example:"I have a strong track record of building teams from scratch.", category:"professional" },
  { word:"translate", hindi:"अनुवाद करना/परिवर्तित करना", partOfSpeech:"verb", meaning:"to convert; to make understandable to others", example:"I translate complex technical concepts into simple business language.", category:"communication" },
  { word:"trust-building", hindi:"विश्वास निर्माण", partOfSpeech:"noun/adjective", meaning:"the process of establishing trust with others", example:"Trust-building is the foundation of every client relationship I maintain.", category:"communication" },
  { word:"unconventional", hindi:"अपरंपरागत", partOfSpeech:"adjective", meaning:"not based on or conforming to what is expected", example:"My unconventional career path is my greatest competitive advantage.", category:"career" },
  { word:"unique value proposition", hindi:"अनूठी मूल्य प्रस्तावना", partOfSpeech:"noun phrase", meaning:"what makes you distinctly valuable compared to others", example:"My unique value proposition is the intersection of tech and empathy.", category:"professional" },
  { word:"value-add", hindi:"मूल्य-वर्धन", partOfSpeech:"noun/adjective", meaning:"something that provides additional benefit or value", example:"Mentoring junior colleagues is a value-add I am passionate about.", category:"professional" },
  { word:"vast", hindi:"विशाल", partOfSpeech:"adjective", meaning:"of very great extent or quantity", example:"My experience spans a vast range of industries.", category:"general" },
  { word:"velocity", hindi:"गति/रफ्तार", partOfSpeech:"noun", meaning:"speed; especially in a professional context (pace of work)", example:"Our team operates at high velocity without sacrificing quality.", category:"work" },
  { word:"witness", hindi:"गवाह बनना/देखना", partOfSpeech:"verb/noun", meaning:"to see something happen", example:"I have witnessed the industry transform entirely in just 10 years.", category:"general" },
  { word:"yield", hindi:"उत्पन्न करना/परिणाम देना", partOfSpeech:"verb/noun", meaning:"to produce or provide; the amount produced", example:"My investment in self-education continues to yield significant returns.", category:"general" }
];

const newWords = [];
const existingWords = new Set(currentWords.map(w => (w.word || '').toLowerCase()));
...
currentVocab.vocabulary = allWords;
currentVocab.totalWords = allWords.length;
currentVocab.categories = [...new Set(allWords.map(w => w.category || 'general'))];

write('vocabulary.json', currentVocab);
console.log(`✅  vocabulary.json updated from ${currentWords.length} → ${allWords.length} words`);
console.log('');
console.log('🎉 ALL DAY 02 EXTENDED CONTENT GENERATED!');
